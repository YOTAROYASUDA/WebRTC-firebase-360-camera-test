 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const q_="FirebaseError";class ds extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=q_,Object.setPrototypeOf(this,ds.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,zf.prototype.create)}}class zf{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},r=`${this.service}/${t}`,s=this.errors[t],o=s?j_(s,n):"Error",l=`${this.serviceName}: ${o} (${r}).`;return new ds(r,l,n)}}function j_(i,t){return i.replace($_,(e,n)=>{const r=t[n];return r!=null?String(r):`<${n}?>`})}const $_=/\{\$([^}]+)}/g;function ma(i,t){if(i===t)return!0;const e=Object.keys(i),n=Object.keys(t);for(const r of e){if(!n.includes(r))return!1;const s=i[r],o=t[r];if(Dh(s)&&Dh(o)){if(!ma(s,o))return!1}else if(s!==o)return!1}for(const r of n)if(!e.includes(r))return!1;return!0}function Dh(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y_{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const n=new U_;if(this.instancesDeferred.set(e,n),this.isInitialized(e)||this.shouldAutoInitialize())try{const r=this.getOrInitializeService({instanceIdentifier:e});r&&n.resolve(r)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const n=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),r=(e=t==null?void 0:t.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(n)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:n})}catch(s){if(r)return null;throw s}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Z_(t))try{this.getOrInitializeService({instanceIdentifier:sr})}catch{}for(const[e,n]of this.instancesDeferred.entries()){const r=this.normalizeInstanceIdentifier(e);try{const s=this.getOrInitializeService({instanceIdentifier:r});n.resolve(s)}catch{}}}}clearInstance(t=sr){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=sr){return this.instances.has(t)}getOptions(t=sr){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,n=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(n))throw Error(`${this.name}(${n}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const r=this.getOrInitializeService({instanceIdentifier:n,options:e});for(const[s,o]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);n===l&&o.resolve(r)}return r}onInit(t,e){var n;const r=this.normalizeInstanceIdentifier(e),s=(n=this.onInitCallbacks.get(r))!==null&&n!==void 0?n:new Set;s.add(t),this.onInitCallbacks.set(r,s);const o=this.instances.get(r);return o&&t(o,r),()=>{s.delete(t)}}invokeOnInitCallbacks(t,e){const n=this.onInitCallbacks.get(e);if(n)for(const r of n)try{r(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let n=this.instances.get(t);if(!n&&this.component&&(n=this.component.instanceFactory(this.container,{instanceIdentifier:K_(t),options:e}),this.instances.set(t,n),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(n,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,n)}catch{}return n||null}normalizeInstanceIdentifier(t=sr){return this.component?this.component.multipleInstances?t:sr:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function K_(i){return i===sr?void 0:i}function Z_(i){return i.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _a=new Map,Wg=new Map,Ql=new Map;function Fh(i,t){try{i.container.addComponent(t)}catch(e){_i.debug(`Component ${t.name} failed to register with FirebaseApp ${i.name}`,e)}}function ga(i){const t=i.name;if(Ql.has(t))return _i.debug(`There were multiple attempts to register component ${t}.`),!1;Ql.set(t,i);for(const e of _a.values())Fh(e,i);for(const e of Wg.values())Fh(e,i);return!0}function Xg(i,t){const e=i.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),i.container.getProvider(t)}function qg(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yg=Hg;function Xf(i,t={}){let e=i;typeof t!="object"&&(t={name:t});const n=Object.assign({name:Zl,automaticDataCollectionEnabled:!0},t),r=n.name;if(typeof r!="string"||!r)throw Ui.create("bad-app-name",{appName:String(r)});if(e||(e=kf()),!e)throw Ui.create("no-options");const s=_a.get(r);if(s){if(ma(e,s.options)&&ma(n,s.config))return s;throw Ui.create("duplicate-app",{appName:r})}const o=new Q_(r);for(const c of Ql.values())o.addComponent(c);const l=new $g(e,n,o);return _a.set(r,l),l}function Kg(i=Zl){const t=_a.get(i);if(!t&&i===Zl&&kf())return Xf();if(!t)throw Ui.create("no-app",{appName:i});return t}function $r(i,t,e){var n;let r=(n=Gg[i])!==null&&n!==void 0?n:i;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const l=[`Unable to register library "${r}" with version "${t}":`];s&&l.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),_i.warn(l.join(" "));return}ga(new Xs(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zg="firebase-heartbeat-database",Qg=1,qs="firebase-heartbeat-store";let dl=null;function qf(){return dl||(dl=hg(Zg,Qg,{upgrade:(i,t)=>{switch(t){case 0:try{i.createObjectStore(qs)}catch(e){console.warn(e)}}}}).catch(i=>{throw Ui.create("idb-open",{originalErrorMessage:i.message})})),dl}async function Jg(i){try{const e=(await qf()).transaction(qs),n=await e.objectStore(qs).get(jf(i));return await e.done,n}catch(t){if(t instanceof ds)_i.warn(t.message);else{const e=Ui.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});_i.warn(e.message)}}}async function Vh(i,t){try{const n=(await qf()).transaction(qs,"readwrite");await n.objectStore(qs).put(t,jf(i)),await n.done}catch(e){if(e instanceof ds)_i.warn(e.message);else{const n=Ui.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});_i.warn(n.message)}}}function jf(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ov(i){ga(new Xs("platform-logger",t=>new pg(t),"PRIVATE")),ga(new Xs("heartbeat",t=>new nv(t),"PRIVATE")),$r(Kl,Oh,i),$r(Kl,Oh,"esm2017"),$r("fire-js","")}ov("");var av="firebase",lv="11.8.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=new Hf("@firebase/firestore");function Hr(){return fr.logLevel}function Tt(i,...t){if(fr.logLevel<=ue.DEBUG){const e=t.map(hu);fr.debug(`Firestore (${fs}): ${i}`,...e)}}function gi(i,...t){if(fr.logLevel<=ue.ERROR){const e=t.map(hu);fr.error(`Firestore (${fs}): ${i}`,...e)}}function ts(i,...t){if(fr.logLevel<=ue.WARN){const e=t.map(hu);fr.warn(`Firestore (${fs}): ${i}`,...e)}}function hu(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(i,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,tp(i,n,e)}function tp(i,t,e){let n=`FIRESTORE (${fs}) INTERNAL ASSERTION FAILED: ${t} (ID: ${i.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw gi(n),new Error(n)}function _e(i,t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,i||tp(t,r,n)}function $t(i,t){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const js=-1;function vv(i,t){const e=i.toTimestamp().seconds,n=i.toTimestamp().nanoseconds+1,r=qt.fromTimestamp(n===1e9?new We(e+1,0):new We(e,n));return new zi(r,Bt.empty(),t)}function yv(i){return new zi(i.readTime,i.key,js)}class zi{constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}static min(){return new zi(qt.min(),Bt.empty(),js)}static max(){return new zi(qt.max(),Bt.empty(),js)}}function Ev(i,t){let e=i.readTime.compareTo(t.readTime);return e!==0?e:(e=Bt.comparator(i.documentKey,t.documentKey),e!==0?e:Jt(i.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ps(i){if(i.code!==ot.FAILED_PRECONDITION||i.message!==Tv)throw i;Tt("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kh(i){let t=0;for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t++;return t}function Yi(i,t){for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t(e,i[e])}function sp(i){for(const t in i)if(Object.prototype.hasOwnProperty.call(i,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xe{constructor(t){this.comparator=t,this.data=new Ie(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal((e,n)=>(t(e),!1))}forEachInRange(t,e){const n=this.data.getIteratorFrom(t[0]);for(;n.hasNext();){const r=n.getNext();if(this.comparator(r.key,t[1])>=0)return;e(r.key)}}forEachWhile(t,e){let n;for(n=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();n.hasNext();)if(!t(n.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new Zh(this.data.getIterator())}getIteratorFrom(t){return new Zh(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach(n=>{e=e.add(n)}),e}isEqual(t){if(!(t instanceof Xe)||this.size!==t.size)return!1;const e=this.data.getIterator(),n=t.data.getIterator();for(;e.hasNext();){const r=e.getNext().key,s=n.getNext().key;if(this.comparator(r,s)!==0)return!1}return!0}toArray(){const t=[];return this.forEach(e=>{t.push(e)}),t}toString(){const t=[];return this.forEach(e=>t.push(e)),"SortedSet("+t.toString()+")"}copy(t){const e=new Xe(this.comparator);return e.data=t,e}}class Zh{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rv{constructor(t,e,n,r,s,o,l,c,u,h){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=r,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=l,this.longPollingOptions=c,this.useFetchStreams=u,this.isUsingEmulator=h}}const ya="(default)";class Ys{constructor(t,e){this.projectId=t,this.database=e||ya}static empty(){return new Ys("","")}get isDefaultDatabase(){return this.database===ya}isEqual(t){return t instanceof Ys&&t.projectId===this.projectId&&t.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hp="__type__",Cv="__max__",wo={mapValue:{}},dp="__vector__",Ea="value";function Wi(i){return"nullValue"in i?0:"booleanValue"in i?1:"integerValue"in i||"doubleValue"in i?2:"timestampValue"in i?3:"stringValue"in i?5:"bytesValue"in i?6:"referenceValue"in i?7:"geoPointValue"in i?8:"arrayValue"in i?9:"mapValue"in i?fu(i)?4:Pv(i)?9007199254740991:Iv(i)?10:11:Ht(28295,{value:i})}function Jn(i,t){if(i===t)return!0;const e=Wi(i);if(e!==Wi(t))return!1;switch(e){case 0:case 9007199254740991:return!0;case 1:return i.booleanValue===t.booleanValue;case 4:return $s(i).isEqual($s(t));case 3:return function(r,s){if(typeof r.timestampValue=="string"&&typeof s.timestampValue=="string"&&r.timestampValue.length===s.timestampValue.length)return r.timestampValue===s.timestampValue;const o=Hi(r.timestampValue),l=Hi(s.timestampValue);return o.seconds===l.seconds&&o.nanos===l.nanos}(i,t);case 5:return i.stringValue===t.stringValue;case 6:return function(r,s){return Gi(r.bytesValue).isEqual(Gi(s.bytesValue))}(i,t);case 7:return i.referenceValue===t.referenceValue;case 8:return function(r,s){return Ne(r.geoPointValue.latitude)===Ne(s.geoPointValue.latitude)&&Ne(r.geoPointValue.longitude)===Ne(s.geoPointValue.longitude)}(i,t);case 2:return function(r,s){if("integerValue"in r&&"integerValue"in s)return Ne(r.integerValue)===Ne(s.integerValue);if("doubleValue"in r&&"doubleValue"in s){const o=Ne(r.doubleValue),l=Ne(s.doubleValue);return o===l?va(o)===va(l):isNaN(o)&&isNaN(l)}return!1}(i,t);case 9:return es(i.arrayValue.values||[],t.arrayValue.values||[],Jn);case 10:case 11:return function(r,s){const o=r.mapValue.fields||{},l=s.mapValue.fields||{};if(Kh(o)!==Kh(l))return!1;for(const c in o)if(o.hasOwnProperty(c)&&(l[c]===void 0||!Jn(o[c],l[c])))return!1;return!0}(i,t);default:return Ht(52216,{left:i})}}function Ks(i,t){return(i.values||[]).find(e=>Jn(e,t))!==void 0}function ns(i,t){if(i===t)return 0;const e=Wi(i),n=Wi(t);if(e!==n)return Jt(e,n);switch(e){case 0:case 9007199254740991:return 0;case 1:return Jt(i.booleanValue,t.booleanValue);case 2:return function(s,o){const l=Ne(s.integerValue||s.doubleValue),c=Ne(o.integerValue||o.doubleValue);return l<c?-1:l>c?1:l===c?0:isNaN(l)?isNaN(c)?0:-1:1}(i,t);case 3:return Qh(i.timestampValue,t.timestampValue);case 4:return Qh($s(i),$s(t));case 5:return tc(i.stringValue,t.stringValue);case 6:return function(s,o){const l=Gi(s),c=Gi(o);return l.compareTo(c)}(i.bytesValue,t.bytesValue);case 7:return function(s,o){const l=s.split("/"),c=o.split("/");for(let u=0;u<l.length&&u<c.length;u++){const h=Jt(l[u],c[u]);if(h!==0)return h}return Jt(l.length,c.length)}(i.referenceValue,t.referenceValue);case 8:return function(s,o){const l=Jt(Ne(s.latitude),Ne(o.latitude));return l!==0?l:Jt(Ne(s.longitude),Ne(o.longitude))}(i.geoPointValue,t.geoPointValue);case 9:return Jh(i.arrayValue,t.arrayValue);case 10:return function(s,o){var l,c,u,h;const d=s.fields||{},p=o.fields||{},_=(l=d[Ea])===null||l===void 0?void 0:l.arrayValue,x=(c=p[Ea])===null||c===void 0?void 0:c.arrayValue,b=Jt(((u=_==null?void 0:_.values)===null||u===void 0?void 0:u.length)||0,((h=x==null?void 0:x.values)===null||h===void 0?void 0:h.length)||0);return b!==0?b:Jh(_,x)}(i.mapValue,t.mapValue);case 11:return function(s,o){if(s===wo.mapValue&&o===wo.mapValue)return 0;if(s===wo.mapValue)return 1;if(o===wo.mapValue)return-1;const l=s.fields||{},c=Object.keys(l),u=o.fields||{},h=Object.keys(u);c.sort(),h.sort();for(let d=0;d<c.length&&d<h.length;++d){const p=tc(c[d],h[d]);if(p!==0)return p;const _=ns(l[c[d]],u[h[d]]);if(_!==0)return _}return Jt(c.length,h.length)}(i.mapValue,t.mapValue);default:throw Ht(23264,{Pe:e})}}function Qh(i,t){if(typeof i=="string"&&typeof t=="string"&&i.length===t.length)return Jt(i,t);const e=Hi(i),n=Hi(t),r=Jt(e.seconds,n.seconds);return r!==0?r:Jt(e.nanos,n.nanos)}function Jh(i,t){const e=i.values||[],n=t.values||[];for(let r=0;r<e.length&&r<n.length;++r){const s=ns(e[r],n[r]);if(s)return s}return Jt(e.length,n.length)}function is(i){return ec(i)}function ec(i){return"nullValue"in i?"null":"booleanValue"in i?""+i.booleanValue:"integerValue"in i?""+i.integerValue:"doubleValue"in i?""+i.doubleValue:"timestampValue"in i?function(e){const n=Hi(e);return`time(${n.seconds},${n.nanos})`}(i.timestampValue):"stringValue"in i?i.stringValue:"bytesValue"in i?function(e){return Gi(e).toBase64()}(i.bytesValue):"referenceValue"in i?function(e){return Bt.fromName(e).toString()}(i.referenceValue):"geoPointValue"in i?function(e){return`geo(${e.latitude},${e.longitude})`}(i.geoPointValue):"arrayValue"in i?function(e){let n="[",r=!0;for(const s of e.values||[])r?r=!1:n+=",",n+=ec(s);return n+"]"}(i.arrayValue):"mapValue"in i?function(e){const n=Object.keys(e.fields||{}).sort();let r="{",s=!0;for(const o of n)s?s=!1:r+=",",r+=`${o}:${ec(e.fields[o])}`;return r+"}"}(i.mapValue):Ht(61005,{value:i})}function Jo(i){switch(Wi(i)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const t=Va(i);return t?16+Jo(t):16;case 5:return 2*i.stringValue.length;case 6:return Gi(i.bytesValue).approximateByteSize();case 7:return i.referenceValue.length;case 9:return function(n){return(n.values||[]).reduce((r,s)=>r+Jo(s),0)}(i.arrayValue);case 10:case 11:return function(n){let r=0;return Yi(n.fields,(s,o)=>{r+=s.length+Jo(o)}),r}(i.mapValue);default:throw Ht(13486,{value:i})}}function nc(i){return!!i&&"integerValue"in i}function pu(i){return!!i&&"arrayValue"in i}function td(i){return!!i&&"nullValue"in i}function ed(i){return!!i&&"doubleValue"in i&&isNaN(Number(i.doubleValue))}function ta(i){return!!i&&"mapValue"in i}function Iv(i){var t,e;return((e=(((t=i==null?void 0:i.mapValue)===null||t===void 0?void 0:t.fields)||{})[hp])===null||e===void 0?void 0:e.stringValue)===dp}function Bs(i){if(i.geoPointValue)return{geoPointValue:Object.assign({},i.geoPointValue)};if(i.timestampValue&&typeof i.timestampValue=="object")return{timestampValue:Object.assign({},i.timestampValue)};if(i.mapValue){const t={mapValue:{fields:{}}};return Yi(i.mapValue.fields,(e,n)=>t.mapValue.fields[e]=Bs(n)),t}if(i.arrayValue){const t={arrayValue:{values:[]}};for(let e=0;e<(i.arrayValue.values||[]).length;++e)t.arrayValue.values[e]=Bs(i.arrayValue.values[e]);return t}return Object.assign({},i)}function Pv(i){return(((i.mapValue||{}).fields||{}).__type__||{}).stringValue===Cv}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(t){this.value=t}static empty(){return new Tn({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let n=0;n<t.length-1;++n)if(e=(e.mapValue.fields||{})[t.get(n)],!ta(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=Bs(e)}setAll(t){let e=Je.emptyPath(),n={},r=[];t.forEach((o,l)=>{if(!e.isImmediateParentOf(l)){const c=this.getFieldsMap(e);this.applyChanges(c,n,r),n={},r=[],e=l.popLast()}o?n[l.lastSegment()]=Bs(o):r.push(l.lastSegment())});const s=this.getFieldsMap(e);this.applyChanges(s,n,r)}delete(t){const e=this.field(t.popLast());ta(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return Jn(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let n=0;n<t.length;++n){let r=e.mapValue.fields[t.get(n)];ta(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},e.mapValue.fields[t.get(n)]=r),e=r}return e.mapValue.fields}applyChanges(t,e,n){Yi(e,(r,s)=>t[r]=s);for(const r of n)delete t[r]}clone(){return new Tn(Bs(this.value))}}function fp(i){const t=[];return Yi(i.fields,(e,n)=>{const r=new Je([e]);if(ta(n)){const s=fp(n.mapValue).fields;if(s.length===0)t.push(r);else for(const o of s)t.push(r.child(o))}else t.push(r)}),new Cn(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cn{constructor(t,e,n,r,s,o,l){this.key=t,this.documentType=e,this.version=n,this.readTime=r,this.createTime=s,this.data=o,this.documentState=l}static newInvalidDocument(t){return new cn(t,0,qt.min(),qt.min(),qt.min(),Tn.empty(),0)}static newFoundDocument(t,e,n,r){return new cn(t,1,e,qt.min(),n,r,0)}static newNoDocument(t,e){return new cn(t,2,e,qt.min(),qt.min(),Tn.empty(),0)}static newUnknownDocument(t,e){return new cn(t,3,e,qt.min(),qt.min(),Tn.empty(),2)}convertToFoundDocument(t,e){return!this.createTime.isEqual(qt.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=t),this.version=t,this.documentType=1,this.data=e,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=Tn.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=Tn.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=qt.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(t){return t instanceof cn&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new cn(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pp{}class Ge extends pp{constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}static create(t,e,n){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,n):new Nv(t,e,n):e==="array-contains"?new Fv(t,n):e==="in"?new Vv(t,n):e==="not-in"?new Bv(t,n):e==="array-contains-any"?new kv(t,n):new Ge(t,e,n)}static createKeyFieldInFilter(t,e,n){return e==="in"?new Uv(t,n):new Ov(t,n)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(ns(e,this.value)):e!==null&&Wi(this.value)===Wi(e)&&this.matchesComparison(ns(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return Ht(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ti extends pp{constructor(t,e){super(),this.filters=t,this.op=e,this.Te=null}static create(t,e){return new ti(t,e)}matches(t){return mp(this)?this.filters.find(e=>!e.matches(t))===void 0:this.filters.find(e=>e.matches(t))!==void 0}getFlattenedFilters(){return this.Te!==null||(this.Te=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function mp(i){return i.op==="and"}function _p(i){return Lv(i)&&mp(i)}function Lv(i){for(const t of i.filters)if(t instanceof ti)return!1;return!0}function ic(i){if(i instanceof Ge)return i.field.canonicalString()+i.op.toString()+is(i.value);if(_p(i))return i.filters.map(t=>ic(t)).join(",");{const t=i.filters.map(e=>ic(e)).join(",");return`${i.op}(${t})`}}function gp(i,t){return i instanceof Ge?function(n,r){return r instanceof Ge&&n.op===r.op&&n.field.isEqual(r.field)&&Jn(n.value,r.value)}(i,t):i instanceof ti?function(n,r){return r instanceof ti&&n.op===r.op&&n.filters.length===r.filters.length?n.filters.reduce((s,o,l)=>s&&gp(o,r.filters[l]),!0):!1}(i,t):void Ht(19439)}function vp(i){return i instanceof Ge?function(e){return`${e.field.canonicalString()} ${e.op} ${is(e.value)}`}(i):i instanceof ti?function(e){return e.op.toString()+" {"+e.getFilters().map(vp).join(" ,")+"}"}(i):"Filter"}class Nv extends Ge{constructor(t,e,n){super(t,e,n),this.key=Bt.fromName(n.referenceValue)}matches(t){const e=Bt.comparator(t.key,this.key);return this.matchesComparison(e)}}class Uv extends Ge{constructor(t,e){super(t,"in",e),this.keys=yp("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class Ov extends Ge{constructor(t,e){super(t,"not-in",e),this.keys=yp("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function yp(i,t){var e;return(((e=t.arrayValue)===null||e===void 0?void 0:e.values)||[]).map(n=>Bt.fromName(n.referenceValue))}class Fv extends Ge{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return pu(e)&&Ks(e.arrayValue,this.value)}}class Vv extends Ge{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&Ks(this.value.arrayValue,e)}}class Bv extends Ge{constructor(t,e){super(t,"not-in",e)}matches(t){if(Ks(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!Ks(this.value.arrayValue,e)}}class kv extends Ge{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!pu(e)||!e.arrayValue.values)&&e.arrayValue.values.some(n=>Ks(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ba{constructor(t,e=null,n=[],r=[],s=null,o="F",l=null,c=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=r,this.limit=s,this.limitType=o,this.startAt=l,this.endAt=c,this.Ee=null,this.de=null,this.Ae=null,this.startAt,this.endAt}}function Hv(i,t,e,n,r,s,o,l){return new Ba(i,t,e,n,r,s,o,l)}function ka(i){return new Ba(i)}function sd(i){return i.filters.length===0&&i.limit===null&&i.startAt==null&&i.endAt==null&&(i.explicitOrderBy.length===0||i.explicitOrderBy.length===1&&i.explicitOrderBy[0].field.isKeyField())}function Gv(i){return i.collectionGroup!==null}function ks(i){const t=$t(i);if(t.Ee===null){t.Ee=[];const e=new Set;for(const s of t.explicitOrderBy)t.Ee.push(s),e.add(s.field.canonicalString());const n=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";(function(o){let l=new Xe(Je.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(u=>{u.isInequality()&&(l=l.add(u.field))})}),l})(t).forEach(s=>{e.has(s.canonicalString())||s.isKeyField()||t.Ee.push(new xa(s,n))}),e.has(Je.keyField().canonicalString())||t.Ee.push(new xa(Je.keyField(),n))}return t.Ee}function Yn(i){const t=$t(i);return t.de||(t.de=Wv(t,ks(i))),t.de}function Wv(i,t){if(i.limitType==="F")return rd(i.path,i.collectionGroup,t,i.filters,i.limit,i.startAt,i.endAt);{t=t.map(r=>{const s=r.dir==="desc"?"asc":"desc";return new xa(r.field,s)});const e=i.endAt?new Ta(i.endAt.position,i.endAt.inclusive):null,n=i.startAt?new Ta(i.startAt.position,i.startAt.inclusive):null;return rd(i.path,i.collectionGroup,t,i.filters,i.limit,e,n)}}function sc(i,t,e){return new Ba(i.path,i.collectionGroup,i.explicitOrderBy.slice(),i.filters.slice(),t,e,i.startAt,i.endAt)}function za(i,t){return _u(Yn(i),Yn(t))&&i.limitType===t.limitType}function Ep(i){return`${mu(Yn(i))}|lt:${i.limitType}`}function Gr(i){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(r=>vp(r)).join(", ")}]`),Fa(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(r=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(r)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>is(r)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>is(r)).join(",")),`Target(${n})`}(Yn(i))}; limitType=${i.limitType})`}function Ha(i,t){return t.isFoundDocument()&&function(n,r){const s=r.key.path;return n.collectionGroup!==null?r.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(s):Bt.isDocumentKey(n.path)?n.path.isEqual(s):n.path.isImmediateParentOf(s)}(i,t)&&function(n,r){for(const s of ks(n))if(!s.field.isKeyField()&&r.data.field(s.field)===null)return!1;return!0}(i,t)&&function(n,r){for(const s of n.filters)if(!s.matches(r))return!1;return!0}(i,t)&&function(n,r){return!(n.startAt&&!function(o,l,c){const u=nd(o,l,c);return o.inclusive?u<=0:u<0}(n.startAt,ks(n),r)||n.endAt&&!function(o,l,c){const u=nd(o,l,c);return o.inclusive?u>=0:u>0}(n.endAt,ks(n),r))}(i,t)}function Xv(i){return i.collectionGroup||(i.path.length%2==1?i.path.lastSegment():i.path.get(i.path.length-2))}function Tp(i){return(t,e)=>{let n=!1;for(const r of ks(i)){const s=qv(r,t,e);if(s!==0)return s;n=n||r.field.isKeyField()}return 0}}function qv(i,t,e){const n=i.field.isKeyField()?Bt.comparator(t.key,e.key):function(s,o,l){const c=o.data.field(s),u=l.data.field(s);return c!==null&&u!==null?ns(c,u):Ht(42886)}(i.field,t,e);switch(i.dir){case"asc":return n;case"desc":return-1*n;default:return Ht(19790,{direction:i.dir})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jv=new Ie(Bt.comparator);function vi(){return jv}const xp=new Ie(Bt.comparator);function Ns(...i){let t=xp;for(const e of i)t=t.insert(e.key,e);return t}function Sp(i){let t=xp;return i.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function ur(){return zs()}function Mp(){return zs()}function zs(){return new yr(i=>i.toString(),(i,t)=>i.isEqual(t))}const $v=new Ie(Bt.comparator),Yv=new Xe(Bt.comparator);function ie(...i){let t=Yv;for(const e of i)t=t.add(e);return t}const Kv=new Xe(Jt);function Zv(){return Kv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gu(i,t){if(i.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:va(t)?"-0":t}}function Ap(i){return{integerValue:""+i}}function Qv(i,t){return Mv(t)?Ap(t):gu(i,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ga{constructor(){this._=void 0}}function Jv(i,t,e){return i instanceof Sa?function(r,s){const o={fields:{[lp]:{stringValue:ap},[up]:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return s&&fu(s)&&(s=Va(s)),s&&(o.fields[cp]=s),{mapValue:o}}(e,t):i instanceof Zs?bp(i,t):i instanceof Qs?Rp(i,t):function(r,s){const o=wp(r,s),l=od(o)+od(r.Re);return nc(o)&&nc(r.Re)?Ap(l):gu(r.serializer,l)}(i,t)}function ty(i,t,e){return i instanceof Zs?bp(i,t):i instanceof Qs?Rp(i,t):e}function wp(i,t){return i instanceof Ma?function(n){return nc(n)||function(s){return!!s&&"doubleValue"in s}(n)}(t)?t:{integerValue:0}:null}class Sa extends Ga{}class Zs extends Ga{constructor(t){super(),this.elements=t}}function bp(i,t){const e=Cp(t);for(const n of i.elements)e.some(r=>Jn(r,n))||e.push(n);return{arrayValue:{values:e}}}class Qs extends Ga{constructor(t){super(),this.elements=t}}function Rp(i,t){let e=Cp(t);for(const n of i.elements)e=e.filter(r=>!Jn(r,n));return{arrayValue:{values:e}}}class Ma extends Ga{constructor(t,e){super(),this.serializer=t,this.Re=e}}function od(i){return Ne(i.integerValue||i.doubleValue)}function Cp(i){return pu(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}function ey(i,t){return i.field.isEqual(t.field)&&function(n,r){return n instanceof Zs&&r instanceof Zs||n instanceof Qs&&r instanceof Qs?es(n.elements,r.elements,Jn):n instanceof Ma&&r instanceof Ma?Jn(n.Re,r.Re):n instanceof Sa&&r instanceof Sa}(i.transform,t.transform)}class ny{constructor(t,e){this.version=t,this.transformResults=e}}class zn{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new zn}static exists(t){return new zn(void 0,t)}static updateTime(t){return new zn(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function ea(i,t){return i.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(i.updateTime):i.exists===void 0||i.exists===t.isFoundDocument()}class Wa{}function Ip(i,t){if(!i.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return i.isNoDocument()?new Dp(i.key,zn.none()):new io(i.key,i.data,zn.none());{const e=i.data,n=Tn.empty();let r=new Xe(Je.comparator);for(let s of t.fields)if(!r.has(s)){let o=e.field(s);o===null&&s.length>1&&(s=s.popLast(),o=e.field(s)),o===null?n.delete(s):n.set(s,o),r=r.add(s)}return new Ki(i.key,n,new Cn(r.toArray()),zn.none())}}function iy(i,t,e){i instanceof io?function(r,s,o){const l=r.value.clone(),c=ld(r.fieldTransforms,s,o.transformResults);l.setAll(c),s.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(i,t,e):i instanceof Ki?function(r,s,o){if(!ea(r.precondition,s))return void s.convertToUnknownDocument(o.version);const l=ld(r.fieldTransforms,s,o.transformResults),c=s.data;c.setAll(Pp(r)),c.setAll(l),s.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(i,t,e):function(r,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()}(0,t,e)}function Hs(i,t,e,n){return i instanceof io?function(s,o,l,c){if(!ea(s.precondition,o))return l;const u=s.value.clone(),h=cd(s.fieldTransforms,c,o);return u.setAll(h),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),null}(i,t,e,n):i instanceof Ki?function(s,o,l,c){if(!ea(s.precondition,o))return l;const u=cd(s.fieldTransforms,c,o),h=o.data;return h.setAll(Pp(s)),h.setAll(u),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),l===null?null:l.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(d=>d.field))}(i,t,e,n):function(s,o,l){return ea(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):l}(i,t,e)}function ry(i,t){let e=null;for(const n of i.fieldTransforms){const r=t.data.field(n.field),s=wp(n.transform,r||null);s!=null&&(e===null&&(e=Tn.empty()),e.set(n.field,s))}return e||null}function ad(i,t){return i.type===t.type&&!!i.key.isEqual(t.key)&&!!i.precondition.isEqual(t.precondition)&&!!function(n,r){return n===void 0&&r===void 0||!(!n||!r)&&es(n,r,(s,o)=>ey(s,o))}(i.fieldTransforms,t.fieldTransforms)&&(i.type===0?i.value.isEqual(t.value):i.type!==1||i.data.isEqual(t.data)&&i.fieldMask.isEqual(t.fieldMask))}class io extends Wa{constructor(t,e,n,r=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class Ki extends Wa{constructor(t,e,n,r,s=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=r,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Pp(i){const t=new Map;return i.fieldMask.fields.forEach(e=>{if(!e.isEmpty()){const n=i.data.field(e);t.set(e,n)}}),t}function ld(i,t,e){const n=new Map;_e(i.length===e.length,32656,{Ve:e.length,me:i.length});for(let r=0;r<e.length;r++){const s=i[r],o=s.transform,l=t.data.field(s.field);n.set(s.field,ty(o,l,e[r]))}return n}function cd(i,t,e){const n=new Map;for(const r of i){const s=r.transform,o=e.data.field(r.field);n.set(r.field,Jv(s,o,t))}return n}class Dp extends Wa{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class sy extends Wa{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uy=new Oi([4294967295,4294967295],0);function ud(i){const t=np().encode(i),e=new $f;return e.update(t),new Uint8Array(e.digest())}function hd(i){const t=new DataView(i.buffer),e=t.getUint32(0,!0),n=t.getUint32(4,!0),r=t.getUint32(8,!0),s=t.getUint32(12,!0);return[new Oi([e,n],0),new Oi([r,s],0)]}class yu{constructor(t,e,n){if(this.bitmap=t,this.padding=e,this.hashCount=n,e<0||e>=8)throw new Us(`Invalid padding: ${e}`);if(n<0)throw new Us(`Invalid hash count: ${n}`);if(t.length>0&&this.hashCount===0)throw new Us(`Invalid hash count: ${n}`);if(t.length===0&&e!==0)throw new Us(`Invalid padding when bitmap length is 0: ${e}`);this.pe=8*t.length-e,this.ye=Oi.fromNumber(this.pe)}we(t,e,n){let r=t.add(e.multiply(Oi.fromNumber(n)));return r.compare(uy)===1&&(r=new Oi([r.getBits(0),r.getBits(1)],0)),r.modulo(this.ye).toNumber()}Se(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.pe===0)return!1;const e=ud(t),[n,r]=hd(e);for(let s=0;s<this.hashCount;s++){const o=this.we(n,r,s);if(!this.Se(o))return!1}return!0}static create(t,e,n){const r=t%8==0?0:8-t%8,s=new Uint8Array(Math.ceil(t/8)),o=new yu(s,r,e);return n.forEach(l=>o.insert(l)),o}insert(t){if(this.pe===0)return;const e=ud(t),[n,r]=hd(e);for(let s=0;s<this.hashCount;s++){const o=this.we(n,r,s);this.be(o)}}be(t){const e=Math.floor(t/8),n=t%8;this.bitmap[e]|=1<<n}}class Us extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(t,e,n,r,s){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const r=new Map;return r.set(t,ro.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new Xa(qt.min(),r,new Ie(Jt),vi(),ie())}}class ro{constructor(t,e,n,r,s){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new ro(n,e,ie(),ie(),ie())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */En.DEFAULT_COLLECTION_PERCENTILE=10,En.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,En.DEFAULT=new En(Gp,En.DEFAULT_COLLECTION_PERCENTILE,En.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),En.DISABLED=new En(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ro=null;function hc(){return Ro===null?Ro=function(){return 268435456+Math.round(2147483648*Math.random())}():Ro++,"0x"+Ro.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rn="WebChannelConnection";class hE extends cE{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,n,r,s){const o=hc();return new Promise((l,c)=>{const u=new Yf;u.setWithCredentials(!0),u.listenOnce(Kf.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Qo.NO_ERROR:const d=u.getResponseJson();Tt(rn,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(d)),l(d);break;case Qo.TIMEOUT:Tt(rn,`RPC '${t}' ${o} timed out`),c(new Dt(ot.DEADLINE_EXCEEDED,"Request time out"));break;case Qo.HTTP_ERROR:const p=u.getStatus();if(Tt(rn,`RPC '${t}' ${o} failed with status:`,p,"response text:",u.getResponseText()),p>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const x=_==null?void 0:_.error;if(x&&x.status&&x.message){const b=function(m){const N=m.toLowerCase().replace(/_/g,"-");return Object.values(ot).indexOf(N)>=0?N:ot.UNKNOWN}(x.status);c(new Dt(b,x.message))}else c(new Dt(ot.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new Dt(ot.UNAVAILABLE,"Connection failed."));break;default:Ht(9055,{l_:t,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{Tt(rn,`RPC '${t}' ${o} completed.`)}});const h=JSON.stringify(r);Tt(rn,`RPC '${t}' ${o} sending request:`,r),u.send(e,"POST",h,n,15)})}T_(t,e,n){const r=hc(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",t,"/channel"],o=Jf(),l=Qf(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Ho(c.initMessageHeaders,e,n),c.encodeInitMessageHeaders=!0;const h=s.join("");Tt(rn,`Creating RPC '${t}' stream ${r}: ${h}`,c);const d=o.createWebChannel(h,c);let p=!1,_=!1;const x=new uE({Zo:g=>{_?Tt(rn,`Not sending because RPC '${t}' stream ${r} is closed:`,g):(p||(Tt(rn,`Opening RPC '${t}' stream ${r} transport.`),d.open(),p=!0),Tt(rn,`RPC '${t}' stream ${r} sending:`,g),d.send(g))},Xo:()=>d.close()}),b=(g,m,N)=>{g.listen(m,D=>{try{N(D)}catch(I){setTimeout(()=>{throw I},0)}})};return b(d,Ls.EventType.OPEN,()=>{_||(Tt(rn,`RPC '${t}' stream ${r} transport opened.`),x.__())}),b(d,Ls.EventType.CLOSE,()=>{_||(_=!0,Tt(rn,`RPC '${t}' stream ${r} transport closed`),x.u_())}),b(d,Ls.EventType.ERROR,g=>{_||(_=!0,ts(rn,`RPC '${t}' stream ${r} transport errored. Name:`,g.name,"Message:",g.message),x.u_(new Dt(ot.UNAVAILABLE,"The operation could not be completed")))}),b(d,Ls.EventType.MESSAGE,g=>{var m;if(!_){const N=g.data[0];_e(!!N,16349);const D=N,I=(D==null?void 0:D.error)||((m=D[0])===null||m===void 0?void 0:m.error);if(I){Tt(rn,`RPC '${t}' stream ${r} received error:`,I);const k=I.status;let O=function(y){const v=Fe[y];if(v!==void 0)return Lp(v)}(k),S=I.message;O===void 0&&(O=ot.INTERNAL,S="Unknown error status: "+k+" with message "+I.message),_=!0,x.u_(new Dt(O,S)),d.close()}else Tt(rn,`RPC '${t}' stream ${r} received:`,N),x.c_(N)}}),b(l,Zf.STAT_EVENT,g=>{g.stat===Jl.PROXY?Tt(rn,`RPC '${t}' stream ${r} detected buffering proxy`):g.stat===Jl.NOPROXY&&Tt(rn,`RPC '${t}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{x.a_()},0),x}}function ml(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xd="PersistentStream";class $p{constructor(t,e,n,r,s,o,l,c){this.xi=t,this.y_=n,this.w_=r,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=l,this.listener=c,this.state=0,this.S_=0,this.b_=null,this.D_=null,this.stream=null,this.v_=0,this.C_=new jp(t,e)}F_(){return this.state===1||this.state===5||this.M_()}M_(){return this.state===2||this.state===3}start(){this.v_=0,this.state!==4?this.auth():this.x_()}async stop(){this.F_()&&await this.close(0)}O_(){this.state=0,this.C_.reset()}N_(){this.M_()&&this.b_===null&&(this.b_=this.xi.enqueueAfterDelay(this.y_,6e4,()=>this.B_()))}L_(t){this.k_(),this.stream.send(t)}async B_(){if(this.M_())return this.close(0)}k_(){this.b_&&(this.b_.cancel(),this.b_=null)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}async close(t,e){this.k_(),this.q_(),this.C_.cancel(),this.S_++,t!==4?this.C_.reset():e&&e.code===ot.RESOURCE_EXHAUSTED?(gi(e.toString()),gi("Using maximum backoff delay to prevent overloading the backend."),this.C_.m_()):e&&e.code===ot.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.Q_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.i_(e)}Q_(){}auth(){this.state=1;const t=this.U_(this.S_),e=this.S_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,r])=>{this.S_===e&&this.K_(n,r)},n=>{t(()=>{const r=new Dt(ot.UNKNOWN,"Fetching auth token failed: "+n.message);return this.W_(r)})})}K_(t,e){const n=this.U_(this.S_);this.stream=this.G_(t,e),this.stream.e_(()=>{n(()=>this.listener.e_())}),this.stream.n_(()=>{n(()=>(this.state=2,this.D_=this.xi.enqueueAfterDelay(this.w_,1e4,()=>(this.M_()&&(this.state=3),Promise.resolve())),this.listener.n_()))}),this.stream.i_(r=>{n(()=>this.W_(r))}),this.stream.onMessage(r=>{n(()=>++this.v_==1?this.z_(r):this.onNext(r))})}x_(){this.state=5,this.C_.f_(async()=>{this.state=0,this.start()})}W_(t){return Tt(xd,`close with error: ${t}`),this.stream=null,this.close(4,t)}U_(t){return e=>{this.xi.enqueueAndForget(()=>this.S_===t?e():(Tt(xd,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class dE extends $p{constructor(t,e,n,r,s,o){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}G_(t,e){return this.connection.T_("Listen",t,e)}z_(t){return this.onNext(t)}onNext(t){this.C_.reset();const e=vy(this.serializer,t),n=function(s){if(!("targetChange"in s))return qt.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?qt.min():o.readTime?Kn(o.readTime):qt.min()}(t);return this.listener.j_(e,n)}H_(t){const e={};e.database=cc(this.serializer),e.addTarget=function(s,o){let l;const c=o.target;if(l=rc(c)?{documents:Ty(s,c)}:{query:xy(s,c).gt},l.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){l.resumeToken=Op(s,o.resumeToken);const u=oc(s,o.expectedCount);u!==null&&(l.expectedCount=u)}else if(o.snapshotVersion.compareTo(qt.min())>0){l.readTime=Aa(s,o.snapshotVersion.toTimestamp());const u=oc(s,o.expectedCount);u!==null&&(l.expectedCount=u)}return l}(this.serializer,t);const n=My(this.serializer,t);n&&(e.labels=n),this.L_(e)}J_(t){const e={};e.database=cc(this.serializer),e.removeTarget=t,this.L_(e)}}class fE extends $p{constructor(t,e,n,r,s,o){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}get Y_(){return this.v_>0}start(){this.lastStreamToken=void 0,super.start()}Q_(){this.Y_&&this.Z_([])}G_(t,e){return this.connection.T_("Write",t,e)}z_(t){return _e(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,_e(!t.writeResults||t.writeResults.length===0,55816),this.listener.X_()}onNext(t){_e(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.C_.reset();const e=Ey(t.writeResults,t.commitTime),n=Kn(t.commitTime);return this.listener.ea(n,e)}ta(){const t={};t.database=cc(this.serializer),this.L_(t)}Z_(t){const e={streamToken:this.lastStreamToken,writes:t.map(n=>yy(this.serializer,n))};this.L_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.oa?(gi(e),this.oa=!1):Tt("OnlineStateTracker",e)}la(){this.sa!==null&&(this.sa.cancel(),this.sa=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pr="RemoteStore";class gE{constructor(t,e,n,r,s){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.ha=[],this.Pa=new Map,this.Ta=new Set,this.Ia=[],this.Ea=s,this.Ea.No(o=>{n.enqueueAndForget(async()=>{Er(this)&&(Tt(pr,"Restarting streams for network reachability change."),await async function(c){const u=$t(c);u.Ta.add(4),await so(u),u.da.set("Unknown"),u.Ta.delete(4),await ja(u)}(this))})}),this.da=new _E(n,r)}}async function ja(i){if(Er(i))for(const t of i.Ia)await t(!0)}async function so(i){for(const t of i.Ia)await t(!1)}function Yp(i,t){const e=$t(i);e.Pa.has(t.targetId)||(e.Pa.set(t.targetId,t),Ru(e)?bu(e):_s(e).M_()&&wu(e,t))}function Au(i,t){const e=$t(i),n=_s(e);e.Pa.delete(t),n.M_()&&Kp(e,t),e.Pa.size===0&&(n.M_()?n.N_():Er(e)&&e.da.set("Unknown"))}function wu(i,t){if(i.Aa.Ke(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(qt.min())>0){const e=i.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}_s(i).H_(t)}function Kp(i,t){i.Aa.Ke(t),_s(i).J_(t)}function bu(i){i.Aa=new hy({getRemoteKeysForTarget:t=>i.remoteSyncer.getRemoteKeysForTarget(t),Rt:t=>i.Pa.get(t)||null,Pt:()=>i.datastore.serializer.databaseId}),_s(i).start(),i.da._a()}function Ru(i){return Er(i)&&!_s(i).F_()&&i.Pa.size>0}function Er(i){return $t(i).Ta.size===0}function Zp(i){i.Aa=void 0}async function vE(i){i.da.set("Online")}async function yE(i){i.Pa.forEach((t,e)=>{wu(i,t)})}async function EE(i,t){Zp(i),Ru(i)?(i.da.ca(t),bu(i)):i.da.set("Unknown")}async function TE(i,t,e){if(i.da.set("Online"),t instanceof Up&&t.state===2&&t.cause)try{await async function(r,s){const o=s.cause;for(const l of s.targetIds)r.Pa.has(l)&&(await r.remoteSyncer.rejectListen(l,o),r.Pa.delete(l),r.Aa.removeTarget(l))}(i,t)}catch(n){Tt(pr,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await ba(i,n)}else if(t instanceof na?i.Aa.Xe(t):t instanceof Np?i.Aa.ot(t):i.Aa.nt(t),!e.isEqual(qt.min()))try{const n=await qp(i.localStore);e.compareTo(n)>=0&&await function(s,o){const l=s.Aa.It(o);return l.targetChanges.forEach((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const h=s.Pa.get(u);h&&s.Pa.set(u,h.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,u)=>{const h=s.Pa.get(c);if(!h)return;s.Pa.set(c,h.withResumeToken(tn.EMPTY_BYTE_STRING,h.snapshotVersion)),Kp(s,c);const d=new Li(h.target,c,u,h.sequenceNumber);wu(s,d)}),s.remoteSyncer.applyRemoteEvent(l)}(i,e)}catch(n){Tt(pr,"Failed to raise snapshot:",n),await ba(i,n)}}async function ba(i,t,e){if(!ms(t))throw t;i.Ta.add(1),await so(i),i.da.set("Offline"),e||(e=()=>qp(i.localStore)),i.asyncQueue.enqueueRetryable(async()=>{Tt(pr,"Retrying IndexedDB access"),await e(),i.Ta.delete(1),await ja(i)})}function Qp(i,t){return t().catch(e=>ba(i,e,t))}async function $a(i){const t=$t(i),e=Xi(t);let n=t.ha.length>0?t.ha[t.ha.length-1].batchId:du;for(;xE(t);)try{const r=await iE(t.localStore,n);if(r===null){t.ha.length===0&&e.N_();break}n=r.batchId,SE(t,r)}catch(r){await ba(t,r)}Jp(t)&&tm(t)}function xE(i){return Er(i)&&i.ha.length<10}function SE(i,t){i.ha.push(t);const e=Xi(i);e.M_()&&e.Y_&&e.Z_(t.mutations)}function Jp(i){return Er(i)&&!Xi(i).F_()&&i.ha.length>0}function tm(i){Xi(i).start()}async function ME(i){Xi(i).ta()}async function AE(i){const t=Xi(i);for(const e of i.ha)t.Z_(e.mutations)}async function wE(i,t,e){const n=i.ha.shift(),r=vu.from(n,t,e);await Qp(i,()=>i.remoteSyncer.applySuccessfulWrite(r)),await $a(i)}async function bE(i,t){t&&Xi(i).Y_&&await async function(n,r){if(function(o){return cy(o)&&o!==ot.ABORTED}(r.code)){const s=n.ha.shift();Xi(n).O_(),await Qp(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await $a(n)}}(i,t),Jp(i)&&tm(i)}async function Sd(i,t){const e=$t(i);e.asyncQueue.verifyOperationInProgress(),Tt(pr,"RemoteStore received new credentials");const n=Er(e);e.Ta.add(3),await so(e),n&&e.da.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ta.delete(3),await ja(e)}async function RE(i,t){const e=$t(i);t?(e.Ta.delete(2),await ja(e)):t||(e.Ta.add(2),await so(e),e.da.set("Unknown"))}function _s(i){return i.Ra||(i.Ra=function(e,n,r){const s=$t(e);return s.ra(),new dE(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{e_:vE.bind(null,i),n_:yE.bind(null,i),i_:EE.bind(null,i),j_:TE.bind(null,i)}),i.Ia.push(async t=>{t?(i.Ra.O_(),Ru(i)?bu(i):i.da.set("Unknown")):(await i.Ra.stop(),Zp(i))})),i.Ra}function Xi(i){return i.Va||(i.Va=function(e,n,r){const s=$t(e);return s.ra(),new fE(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{e_:()=>Promise.resolve(),n_:ME.bind(null,i),i_:bE.bind(null,i),X_:AE.bind(null,i),ea:wE.bind(null,i)}),i.Ia.push(async t=>{t?(i.Va.O_(),await $a(i)):(await i.Va.stop(),i.ha.length>0&&(Tt(pr,`Stopping write stream with ${i.ha.length} pending writes`),i.ha=[]))})),i.Va}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dm{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.vu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.vu(this.observer.error,t):gi("Uncaught Error in snapshot listener:",t.toString()))}Cu(){this.muted=!0}vu(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ka{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new Ka(this.firestore,t,this._query)}}class pn{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Vi(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new pn(this.firestore,t,this._key)}}class Vi extends Ka{constructor(t,e,n){super(t,e,ka(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new pn(this.firestore,null,new Bt(t))}withConverter(t){return new Vi(this.firestore,t,this._path)}}function Gs(i,t,...e){if(i=mi(i),mm("collection","path",t),i instanceof Ya){const n=Ce.fromString(t,...e);return Dd(n),new Vi(i,null,n)}{if(!(i instanceof pn||i instanceof Vi))throw new Dt(ot.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=i._path.child(Ce.fromString(t,...e));return Dd(n),new Vi(i.firestore,null,n)}}function Uu(i,t,...e){if(i=mi(i),arguments.length===1&&(t=ip.newId()),mm("doc","path",t),i instanceof Ya){const n=Ce.fromString(t,...e);return Pd(n),new pn(i,null,new Bt(n))}{if(!(i instanceof pn||i instanceof Vi))throw new Dt(ot.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=i._path.child(Ce.fromString(t,...e));return Pd(n),new pn(i.firestore,i instanceof Vi?i.converter:null,new Bt(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new Dt(ot.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Je(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s0=/^__.*__$/;class o0{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return this.fieldMask!==null?new Ki(t,this.data,this.fieldMask,e,this.fieldTransforms):new io(t,this.data,e,this.fieldTransforms)}}class gm{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new Ki(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function vm(i){switch(i){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Ht(40011,{hc:i})}}class ku{constructor(t,e,n,r,s,o){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,s===void 0&&this.Pc(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get hc(){return this.settings.hc}Tc(t){return new ku(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ic(t){var e;const n=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.Tc({path:n,Ec:!1});return r.dc(t),r}Ac(t){var e;const n=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.Tc({path:n,Ec:!1});return r.Pc(),r}Rc(t){return this.Tc({path:void 0,Ec:!0})}Vc(t){return Ca(t,this.settings.methodName,this.settings.mc||!1,this.path,this.settings.fc)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}Pc(){if(this.path)for(let t=0;t<this.path.length;t++)this.dc(this.path.get(t))}dc(t){if(t.length===0)throw this.Vc("Document fields must not be empty");if(vm(this.hc)&&s0.test(t))throw this.Vc('Document fields cannot begin and end with "__"')}}class a0{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||qa(t)}gc(t,e,n,r=!1){return new ku({hc:t,methodName:e,fc:n,path:Je.emptyPath(),Ec:!1,mc:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function zu(i){const t=i._freezeSettings(),e=qa(i._databaseId);return new a0(i._databaseId,!!t.ignoreUndefinedProperties,e)}function ym(i,t,e,n,r,s={}){const o=i.gc(s.merge||s.mergeFields?2:0,t,e,r);Hu("Data must be an object, but it was:",o,n);const l=Em(n,o);let c,u;if(s.merge)c=new Cn(o.fieldMask),u=o.fieldTransforms;else if(s.mergeFields){const h=[];for(const d of s.mergeFields){const p=_c(t,d,e);if(!o.contains(p))throw new Dt(ot.INVALID_ARGUMENT,`Field '${p}' is specified in your field mask but missing from your input data.`);xm(h,p)||h.push(p)}c=new Cn(h),u=o.fieldTransforms.filter(d=>c.covers(d.field))}else c=null,u=o.fieldTransforms;return new o0(new Tn(l),c,u)}class Qa extends Fu{_toFieldTransform(t){if(t.hc!==2)throw t.hc===1?t.Vc(`${this._methodName}() can only appear at the top level of your update data`):t.Vc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof Qa}}function l0(i,t,e,n){const r=i.gc(1,t,e);Hu("Data must be an object, but it was:",r,n);const s=[],o=Tn.empty();Yi(n,(c,u)=>{const h=Gu(t,c,e);u=mi(u);const d=r.Ac(h);if(u instanceof Qa)s.push(h);else{const p=Ja(u,d);p!=null&&(s.push(h),o.set(h,p))}});const l=new Cn(s);return new gm(o,l,r.fieldTransforms)}function c0(i,t,e,n,r,s){const o=i.gc(1,t,e),l=[_c(t,n,e)],c=[r];if(s.length%2!=0)throw new Dt(ot.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let p=0;p<s.length;p+=2)l.push(_c(t,s[p])),c.push(s[p+1]);const u=[],h=Tn.empty();for(let p=l.length-1;p>=0;--p)if(!xm(u,l[p])){const _=l[p];let x=c[p];x=mi(x);const b=o.Ac(_);if(x instanceof Qa)u.push(_);else{const g=Ja(x,b);g!=null&&(u.push(_),h.set(_,g))}}const d=new Cn(u);return new gm(h,d,o.fieldTransforms)}function Ja(i,t){if(Tm(i=mi(i)))return Hu("Unsupported field value:",t,i),Em(i,t);if(i instanceof Fu)return function(n,r){if(!vm(r.hc))throw r.Vc(`${n._methodName}() can only be used with update() and set()`);if(!r.path)throw r.Vc(`${n._methodName}() is not currently supported inside arrays`);const s=n._toFieldTransform(r);s&&r.fieldTransforms.push(s)}(i,t),null;if(i===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),i instanceof Array){if(t.settings.Ec&&t.hc!==4)throw t.Vc("Nested arrays are not supported");return function(n,r){const s=[];let o=0;for(const l of n){let c=Ja(l,r.Rc(o));c==null&&(c={nullValue:"NULL_VALUE"}),s.push(c),o++}return{arrayValue:{values:s}}}(i,t)}return function(n,r){if((n=mi(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return Qv(r.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const s=We.fromDate(n);return{timestampValue:Aa(r.serializer,s)}}if(n instanceof We){const s=new We(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:Aa(r.serializer,s)}}if(n instanceof Vu)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof os)return{bytesValue:Op(r.serializer,n._byteString)};if(n instanceof pn){const s=r.databaseId,o=n.firestore._databaseId;if(!o.isEqual(s))throw r.Vc(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Eu(n.firestore._databaseId||r.databaseId,n._key.path)}}if(n instanceof Bu)return function(o,l){return{mapValue:{fields:{[hp]:{stringValue:dp},[Ea]:{arrayValue:{values:o.toArray().map(u=>{if(typeof u!="number")throw l.Vc("VectorValues must only contain numeric values.");return gu(l.serializer,u)})}}}}}}(n,r);throw r.Vc(`Unsupported field value: ${Nu(n)}`)}(i,t)}function Em(i,t){const e={};return sp(i)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Yi(i,(n,r)=>{const s=Ja(r,t.Ic(n));s!=null&&(e[n]=s)}),{mapValue:{fields:e}}}function Tm(i){return!(typeof i!="object"||i===null||i instanceof Array||i instanceof Date||i instanceof We||i instanceof Vu||i instanceof os||i instanceof pn||i instanceof Fu||i instanceof Bu)}function Hu(i,t,e){if(!Tm(e)||!function(r){return typeof r=="object"&&r!==null&&(Object.getPrototypeOf(r)===Object.prototype||Object.getPrototypeOf(r)===null)}(e)){const n=Nu(e);throw n==="an object"?t.Vc(i+" a custom object"):t.Vc(i+" "+n)}}function _c(i,t,e){if((t=mi(t))instanceof Za)return t._internalPath;if(typeof t=="string")return Gu(i,t);throw Ca("Field path arguments must be of type string or ",i,!1,void 0,e)}const u0=new RegExp("[~\\*/\\[\\]]");function Gu(i,t,e){if(t.search(u0)>=0)throw Ca(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,i,!1,void 0,e);try{return new Za(...t.split("."))._internalPath}catch{throw Ca(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i,!1,void 0,e)}}function Ca(i,t,e,n,r){const s=n&&!n.isEmpty(),o=r!==void 0;let l=`Function ${t}() called with invalid data`;e&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${n}`),o&&(c+=` in document ${r}`),c+=")"),new Dt(ot.INVALID_ARGUMENT,l+i+c)}function xm(i,t){return i.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d0(i){if(i.limitType==="L"&&i.explicitOrderBy.length===0)throw new Dt(ot.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class f0{convertValue(t,e="none"){switch(Wi(t)){case 0:return null;case 1:return t.booleanValue;case 2:return Ne(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Gi(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw Ht(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const n={};return Yi(t,(r,s)=>{n[r]=this.convertValue(s,e)}),n}convertVectorValue(t){var e,n,r;const s=(r=(n=(e=t.fields)===null||e===void 0?void 0:e[Ea].arrayValue)===null||n===void 0?void 0:n.values)===null||r===void 0?void 0:r.map(o=>Ne(o.doubleValue));return new Bu(s)}convertGeoPoint(t){return new Vu(Ne(t.latitude),Ne(t.longitude))}convertArray(t,e){return(t.values||[]).map(n=>this.convertValue(n,e))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Va(t);return n==null?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp($s(t));default:return null}}convertTimestamp(t){const e=Hi(t);return new We(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=Ce.fromString(t);_e(Hp(n),9688,{name:t});const r=new Ys(n.get(1),n.get(3)),s=new Bt(n.popFirst(5));return r.isEqual(e)||gi(`Document ${s} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class wm extends Sm{constructor(t,e,n,r,s,o){super(t,e,n,r,o),this._firestore=t,this._firestoreImpl=t,this.metadata=s}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new ia(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Mm("DocumentSnapshot.get",t));if(n!==null)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class ia extends wm{data(t={}){return super.data(t)}}class p0{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new Os(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new ia(this._firestore,this._userDataWriter,n.key,n,new Os(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new Dt(ot.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(r,s){if(r._snapshot.oldDocs.isEmpty()){let o=0;return r._snapshot.docChanges.map(l=>{const c=new ia(r._firestore,r._userDataWriter,l.doc.key,l.doc,new Os(r._snapshot.mutatedKeys.has(l.doc.key),r._snapshot.fromCache),r.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=r._snapshot.oldDocs;return r._snapshot.docChanges.filter(l=>s||l.type!==3).map(l=>{const c=new ia(r._firestore,r._userDataWriter,l.doc.key,l.doc,new Os(r._snapshot.mutatedKeys.has(l.doc.key),r._snapshot.fromCache),r.query.converter);let u=-1,h=-1;return l.type!==0&&(u=o.indexOf(l.doc.key),o=o.delete(l.doc.key)),l.type!==1&&(o=o.add(l.doc),h=o.indexOf(l.doc.key)),{type:m0(l.type),doc:c,oldIndex:u,newIndex:h}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function m0(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Ht(61501,{type:i})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function gf(){return new $i({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nh(),fragmentShader:`
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function vf(){return new $i({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nh(),fragmentShader:`
...
#define LOW_PRECISION`),t}function ZA(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Pm?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===S0?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ui&&(t="SHADOWMAP_TYPE_VSM"),t}function QA(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ls:case cs:t="ENVMAP_TYPE_CUBE";break;case tl:t="ENVMAP_TYPE_CUBE_UV";break}return t}function JA(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case cs:t="ENVMAP_MODE_REFRACTION";break}return t}function tw(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Dm:t="ENVMAP_BLENDING_MULTIPLY";break;case H0:t="ENVMAP_BLENDING_MIX";break;case G0:t="ENVMAP_BLENDING_ADD";break}return t}function ew(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function nw(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,l=e.fragmentShader;const c=ZA(e),u=QA(e),h=JA(e),d=tw(e),p=ew(e),_=GA(e),x=WA(s),b=r.createProgram();let g,m,N=e.glslVersion?"#version "+e.glslVersion+`
...
`)}function tb(){jn=new Dn(75,window.innerWidth/window.innerHeight,1,1e3),jn.position.set(0,0,.1),su=new BT;const i=new HT(fa);i.colorSpace=Rn;const t=new eh(500,60,40);t.scale(-1,1,1);const e=new th({map:i});su.add(new $n(t,e)),fn=new Iw,fn.setPixelRatio(window.devicePixelRatio),fn.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(fn.domElement),ha=new Dw(jn,fn.domElement),ha.enableZoom=!0,ha.enablePan=!1;const n=(r,s,o)=>Math.max(s,Math.min(r,o));fn.domElement.addEventListener("wheel",r=>{jn.fov=n(jn.fov+r.deltaY/10,10,120),jn.updateProjectionMatrix()}),window.addEventListener("resize",eb)}function eb(){jn&&fn&&(jn.aspect=window.innerWidth/window.innerHeight,jn.updateProjectionMatrix(),fn.setSize(window.innerWidth,window.innerHeight))}function c_(){fn&&(requestAnimationFrame(c_),ha.update(),fn.render(su,jn))}
