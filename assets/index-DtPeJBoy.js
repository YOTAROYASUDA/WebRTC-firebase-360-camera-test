 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rg="FirebaseError";class _s extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=rg,Object.setPrototypeOf(this,_s.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Jf.prototype.create)}}class Jf{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},r=`${this.service}/${t}`,s=this.errors[t],o=s?sg(s,n):"Error",l=`${this.serviceName}: ${o} (${r}).`;return new _s(r,l,n)}}function sg(i,t){return i.replace(og,(e,n)=>{const r=t[n];return r!=null?String(r):`<${n}?>`})}const og=/\{\$([^}]+)}/g;function ya(i,t){if(i===t)return!0;const e=Object.keys(i),n=Object.keys(t);for(const r of e){if(!n.includes(r))return!1;const s=i[r],o=t[r];if(Wh(s)&&Wh(o)){if(!ya(s,o))return!1}else if(s!==o)return!1}for(const r of n)if(!e.includes(r))return!1;return!0}function Wh(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ea=new Map,nv=new Map,cc=new Map;function Yh(i,t){try{i.container.addComponent(t)}catch(e){vi.debug(`Component ${t.name} failed to register with FirebaseApp ${i.name}`,e)}}function Ta(i){const t=i.name;if(cc.has(t))return vi.debug(`There were multiple attempts to register component ${t}.`),!1;cc.set(t,i);for(const e of Ea.values())Yh(e,i);for(const e of nv.values())Yh(e,i);return!0}function iv(i,t){const e=i.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),i.container.getProvider(t)}function rv(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const av=tv;function ip(i,t={}){let e=i;typeof t!="object"&&(t={name:t});const n=Object.assign({name:lc,automaticDataCollectionEnabled:!0},t),r=n.name;if(typeof r!="string"||!r)throw Vi.create("bad-app-name",{appName:String(r)});if(e||(e=Zf()),!e)throw Vi.create("no-options");const s=Ea.get(r);if(s){if(ya(e,s.options)&&ya(n,s.config))return s;throw Vi.create("duplicate-app",{appName:r})}const o=new ug(r);for(const c of cc.values())o.addComponent(c);const l=new ov(e,n,o);return Ea.set(r,l),l}function lv(i=lc){const t=Ea.get(i);if(!t&&i===lc&&Zf())return ip();if(!t)throw Vi.create("no-app",{appName:i});return t}function Zr(i,t,e){var n;let r=(n=ev[i])!==null&&n!==void 0?n:i;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const l=[`Unable to register library "${r}" with version "${t}":`];s&&l.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),vi.warn(l.join(" "));return}Ta(new Ys(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cv="firebase-heartbeat-database",uv=1,Ks="firebase-heartbeat-store";let Sl=null;function rp(){return Sl||(Sl=Sg(cv,uv,{upgrade:(i,t)=>{switch(t){case 0:try{i.createObjectStore(Ks)}catch(e){console.warn(e)}}}}).catch(i=>{throw Vi.create("idb-open",{originalErrorMessage:i.message})})),Sl}async function hv(i){try{const e=(await rp()).transaction(Ks),n=await e.objectStore(Ks).get(sp(i));return await e.done,n}catch(t){if(t instanceof _s)vi.warn(t.message);else{const e=Vi.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});vi.warn(e.message)}}}async function Kh(i,t){try{const n=(await rp()).transaction(Ks,"readwrite");await n.objectStore(Ks).put(t,sp(i)),await n.done}catch(e){if(e instanceof _s)vi.warn(e.message);else{const n=Vi.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});vi.warn(n.message)}}}function sp(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vv(i){Ta(new Ys("platform-logger",t=>new wg(t),"PRIVATE")),Ta(new Ys("heartbeat",t=>new pv(t),"PRIVATE")),Zr(ac,$h,i),Zr(ac,$h,"esm2017"),Zr("fire-js","")}vv("");var yv="firebase",Ev="11.8.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vr=new tp("@firebase/firestore");function qr(){return vr.logLevel}function Tt(i,...t){if(vr.logLevel<=ue.DEBUG){const e=t.map(xu);vr.debug(`Firestore (${gs}): ${i}`,...e)}}function yi(i,...t){if(vr.logLevel<=ue.ERROR){const e=t.map(xu);vr.error(`Firestore (${gs}): ${i}`,...e)}}function rs(i,...t){if(vr.logLevel<=ue.WARN){const e=t.map(xu);vr.warn(`Firestore (${gs}): ${i}`,...e)}}function xu(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(i,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,dp(i,n,e)}function dp(i,t,e){let n=`FIRESTORE (${gs}) INTERNAL ASSERTION FAILED: ${t} (ID: ${i.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw yi(n),new Error(n)}function _e(i,t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,i||dp(t,r,n)}function $t(i,t){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const od="__name__";class jn{constructor(t,e,n){e===void 0?e=0:e>t.length&&Ht(637,{offset:e,range:t.length}),n===void 0?n=t.length-e:n>t.length-e&&Ht(1746,{length:n,range:t.length-e}),this.segments=t,this.offset=e,this.len=n}get length(){return this.len}isEqual(t){return jn.comparator(this,t)===0}child(t){const e=this.segments.slice(this.offset,this.limit());return t instanceof jn?t.forEach(n=>{e.push(n)}):e.push(t),this.construct(e)}limit(){return this.offset+this.length}popFirst(t){return t=t===void 0?1:t,this.construct(this.segments,this.offset+t,this.length-t)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(t){return this.segments[this.offset+t]}isEmpty(){return this.length===0}isPrefixOf(t){if(t.length<this.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}isImmediateParentOf(t){if(this.length+1!==t.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}forEach(t){for(let e=this.offset,n=this.limit();e<n;e++)t(this.segments[e])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(t,e){const n=Math.min(t.length,e.length);for(let r=0;r<n;r++){const s=jn.compareSegments(t.get(r),e.get(r));if(s!==0)return s}return Jt(t.length,e.length)}static compareSegments(t,e){const n=jn.isNumericId(t),r=jn.isNumericId(e);return n&&!r?-1:!n&&r?1:n&&r?jn.extractNumericId(t).compare(jn.extractNumericId(e)):hc(t,e)}static isNumericId(t){return t.startsWith("__id")&&t.endsWith("__")}static extractNumericId(t){return Bi.fromString(t.substring(4,t.length-2))}}class Ce extends jn{construct(t,e,n){return new Ce(t,e,n)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...t){const e=[];for(const n of t){if(n.indexOf("//")>=0)throw new Dt(ot.INVALID_ARGUMENT,`Invalid segment (${n}). Paths must not contain // in them.`);e.push(...n.split("/").filter(r=>r.length>0))}return new Ce(e)}static emptyPath(){return new Ce([])}}const Cv=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class tn extends jn{construct(t,e,n){return new tn(t,e,n)}static isValidIdentifier(t){return Cv.test(t)}canonicalString(){return this.toArray().map(t=>(t=t.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),tn.isValidIdentifier(t)||(t="`"+t+"`"),t)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===od}static keyField(){return new tn([od])}static fromServerFormat(t){const e=[];let n="",r=0;const s=()=>{if(n.length===0)throw new Dt(ot.INVALID_ARGUMENT,`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);e.push(n),n=""};let o=!1;for(;r<t.length;){const l=t[r];if(l==="\\"){if(r+1===t.length)throw new Dt(ot.INVALID_ARGUMENT,"Path has trailing escape character: "+t);const c=t[r+1];if(c!=="\\"&&c!=="."&&c!=="`")throw new Dt(ot.INVALID_ARGUMENT,"Path has invalid escape sequence: "+t);n+=c,r+=2}else l==="`"?(o=!o,r++):l!=="."||o?(n+=l,r++):(s(),r++)}if(s(),o)throw new Dt(ot.INVALID_ARGUMENT,"Unterminated ` in path: "+t);return new tn(e)}static emptyPath(){return new tn([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vs(i){if(i.code!==ot.FAILED_PRECONDITION||i.message!==Lv)throw i;Tt("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ld(i){let t=0;for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t++;return t}function tr(i,t){for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t(e,i[e])}function gp(i){for(const t in i)if(Object.prototype.hasOwnProperty.call(i,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sp="__type__",zv="__max__",Do={mapValue:{}},Mp="__vector__",Ma="value";function $i(i){return"nullValue"in i?0:"booleanValue"in i?1:"integerValue"in i||"doubleValue"in i?2:"timestampValue"in i?3:"stringValue"in i?5:"bytesValue"in i?6:"referenceValue"in i?7:"geoPointValue"in i?8:"arrayValue"in i?9:"mapValue"in i?Mu(i)?4:Gv(i)?9007199254740991:Hv(i)?10:11:Ht(28295,{value:i})}function ti(i,t){if(i===t)return!0;const e=$i(i);if(e!==$i(t))return!1;switch(e){case 0:case 9007199254740991:return!0;case 1:return i.booleanValue===t.booleanValue;case 4:return Zs(i).isEqual(Zs(t));case 3:return function(r,s){if(typeof r.timestampValue=="string"&&typeof s.timestampValue=="string"&&r.timestampValue.length===s.timestampValue.length)return r.timestampValue===s.timestampValue;const o=qi(r.timestampValue),l=qi(s.timestampValue);return o.seconds===l.seconds&&o.nanos===l.nanos}(i,t);case 5:return i.stringValue===t.stringValue;case 6:return function(r,s){return ji(r.bytesValue).isEqual(ji(s.bytesValue))}(i,t);case 7:return i.referenceValue===t.referenceValue;case 8:return function(r,s){return Ue(r.geoPointValue.latitude)===Ue(s.geoPointValue.latitude)&&Ue(r.geoPointValue.longitude)===Ue(s.geoPointValue.longitude)}(i,t);case 2:return function(r,s){if("integerValue"in r&&"integerValue"in s)return Ue(r.integerValue)===Ue(s.integerValue);if("doubleValue"in r&&"doubleValue"in s){const o=Ue(r.doubleValue),l=Ue(s.doubleValue);return o===l?xa(o)===xa(l):isNaN(o)&&isNaN(l)}return!1}(i,t);case 9:return ss(i.arrayValue.values||[],t.arrayValue.values||[],ti);case 10:case 11:return function(r,s){const o=r.mapValue.fields||{},l=s.mapValue.fields||{};if(ld(o)!==ld(l))return!1;for(const c in o)if(o.hasOwnProperty(c)&&(l[c]===void 0||!ti(o[c],l[c])))return!1;return!0}(i,t);default:return Ht(52216,{left:i})}}function to(i,t){return(i.values||[]).find(e=>ti(e,t))!==void 0}function os(i,t){if(i===t)return 0;const e=$i(i),n=$i(t);if(e!==n)return Jt(e,n);switch(e){case 0:case 9007199254740991:return 0;case 1:return Jt(i.booleanValue,t.booleanValue);case 2:return function(s,o){const l=Ue(s.integerValue||s.doubleValue),c=Ue(o.integerValue||o.doubleValue);return l<c?-1:l>c?1:l===c?0:isNaN(l)?isNaN(c)?0:-1:1}(i,t);case 3:return ud(i.timestampValue,t.timestampValue);case 4:return ud(Zs(i),Zs(t));case 5:return hc(i.stringValue,t.stringValue);case 6:return function(s,o){const l=ji(s),c=ji(o);return l.compareTo(c)}(i.bytesValue,t.bytesValue);case 7:return function(s,o){const l=s.split("/"),c=o.split("/");for(let u=0;u<l.length&&u<c.length;u++){const h=Jt(l[u],c[u]);if(h!==0)return h}return Jt(l.length,c.length)}(i.referenceValue,t.referenceValue);case 8:return function(s,o){const l=Jt(Ue(s.latitude),Ue(o.latitude));return l!==0?l:Jt(Ue(s.longitude),Ue(o.longitude))}(i.geoPointValue,t.geoPointValue);case 9:return hd(i.arrayValue,t.arrayValue);case 10:return function(s,o){var l,c,u,h;const d=s.fields||{},p=o.fields||{},_=(l=d[Ma])===null||l===void 0?void 0:l.arrayValue,x=(c=p[Ma])===null||c===void 0?void 0:c.arrayValue,b=Jt(((u=_==null?void 0:_.values)===null||u===void 0?void 0:u.length)||0,((h=x==null?void 0:x.values)===null||h===void 0?void 0:h.length)||0);return b!==0?b:hd(_,x)}(i.mapValue,t.mapValue);case 11:return function(s,o){if(s===Do.mapValue&&o===Do.mapValue)return 0;if(s===Do.mapValue)return 1;if(o===Do.mapValue)return-1;const l=s.fields||{},c=Object.keys(l),u=o.fields||{},h=Object.keys(u);c.sort(),h.sort();for(let d=0;d<c.length&&d<h.length;++d){const p=hc(c[d],h[d]);if(p!==0)return p;const _=os(l[c[d]],u[h[d]]);if(_!==0)return _}return Jt(c.length,h.length)}(i.mapValue,t.mapValue);default:throw Ht(23264,{Pe:e})}}function ud(i,t){if(typeof i=="string"&&typeof t=="string"&&i.length===t.length)return Jt(i,t);const e=qi(i),n=qi(t),r=Jt(e.seconds,n.seconds);return r!==0?r:Jt(e.nanos,n.nanos)}function hd(i,t){const e=i.values||[],n=t.values||[];for(let r=0;r<e.length&&r<n.length;++r){const s=os(e[r],n[r]);if(s)return s}return Jt(e.length,n.length)}function as(i){return dc(i)}function dc(i){return"nullValue"in i?"null":"booleanValue"in i?""+i.booleanValue:"integerValue"in i?""+i.integerValue:"doubleValue"in i?""+i.doubleValue:"timestampValue"in i?function(e){const n=qi(e);return`time(${n.seconds},${n.nanos})`}(i.timestampValue):"stringValue"in i?i.stringValue:"bytesValue"in i?function(e){return ji(e).toBase64()}(i.bytesValue):"referenceValue"in i?function(e){return Bt.fromName(e).toString()}(i.referenceValue):"geoPointValue"in i?function(e){return`geo(${e.latitude},${e.longitude})`}(i.geoPointValue):"arrayValue"in i?function(e){let n="[",r=!0;for(const s of e.values||[])r?r=!1:n+=",",n+=dc(s);return n+"]"}(i.arrayValue):"mapValue"in i?function(e){const n=Object.keys(e.fields||{}).sort();let r="{",s=!0;for(const o of n)s?s=!1:r+=",",r+=`${o}:${dc(e.fields[o])}`;return r+"}"}(i.mapValue):Ht(61005,{value:i})}function sa(i){switch($i(i)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const t=Wa(i);return t?16+sa(t):16;case 5:return 2*i.stringValue.length;case 6:return ji(i.bytesValue).approximateByteSize();case 7:return i.referenceValue.length;case 9:return function(n){return(n.values||[]).reduce((r,s)=>r+sa(s),0)}(i.arrayValue);case 10:case 11:return function(n){let r=0;return tr(n.fields,(s,o)=>{r+=s.length+sa(o)}),r}(i.mapValue);default:throw Ht(13486,{value:i})}}function fc(i){return!!i&&"integerValue"in i}function Au(i){return!!i&&"arrayValue"in i}function dd(i){return!!i&&"nullValue"in i}function fd(i){return!!i&&"doubleValue"in i&&isNaN(Number(i.doubleValue))}function oa(i){return!!i&&"mapValue"in i}function Hv(i){var t,e;return((e=(((t=i==null?void 0:i.mapValue)===null||t===void 0?void 0:t.fields)||{})[Sp])===null||e===void 0?void 0:e.stringValue)===Mp}function Gs(i){if(i.geoPointValue)return{geoPointValue:Object.assign({},i.geoPointValue)};if(i.timestampValue&&typeof i.timestampValue=="object")return{timestampValue:Object.assign({},i.timestampValue)};if(i.mapValue){const t={mapValue:{fields:{}}};return tr(i.mapValue.fields,(e,n)=>t.mapValue.fields[e]=Gs(n)),t}if(i.arrayValue){const t={arrayValue:{values:[]}};for(let e=0;e<(i.arrayValue.values||[]).length;++e)t.arrayValue.values[e]=Gs(i.arrayValue.values[e]);return t}return Object.assign({},i)}function Gv(i){return(((i.mapValue||{}).fields||{}).__type__||{}).stringValue===zv}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn{constructor(t){this.value=t}static empty(){return new Sn({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let n=0;n<t.length-1;++n)if(e=(e.mapValue.fields||{})[t.get(n)],!oa(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=Gs(e)}setAll(t){let e=tn.emptyPath(),n={},r=[];t.forEach((o,l)=>{if(!e.isImmediateParentOf(l)){const c=this.getFieldsMap(e);this.applyChanges(c,n,r),n={},r=[],e=l.popLast()}o?n[l.lastSegment()]=Gs(o):r.push(l.lastSegment())});const s=this.getFieldsMap(e);this.applyChanges(s,n,r)}delete(t){const e=this.field(t.popLast());oa(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return ti(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let n=0;n<t.length;++n){let r=e.mapValue.fields[t.get(n)];oa(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},e.mapValue.fields[t.get(n)]=r),e=r}return e.mapValue.fields}applyChanges(t,e,n){tr(e,(r,s)=>t[r]=s);for(const r of n)delete t[r]}clone(){return new Sn(Gs(this.value))}}function Ap(i){const t=[];return tr(i.fields,(e,n)=>{const r=new tn([e]);if(oa(n)){const s=Ap(n.mapValue).fields;if(s.length===0)t.push(r);else for(const o of s)t.push(r.child(o))}else t.push(r)}),new Dn(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(t,e=null,n=[],r=[],s=null,o="F",l=null,c=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=r,this.limit=s,this.limitType=o,this.startAt=l,this.endAt=c,this.Ee=null,this.de=null,this.Ae=null,this.startAt,this.endAt}}function ty(i,t,e,n,r,s,o,l){return new Xa(i,t,e,n,r,s,o,l)}function qa(i){return new Xa(i)}function gd(i){return i.filters.length===0&&i.limit===null&&i.startAt==null&&i.endAt==null&&(i.explicitOrderBy.length===0||i.explicitOrderBy.length===1&&i.explicitOrderBy[0].field.isKeyField())}function ey(i){return i.collectionGroup!==null}function Ws(i){const t=$t(i);if(t.Ee===null){t.Ee=[];const e=new Set;for(const s of t.explicitOrderBy)t.Ee.push(s),e.add(s.field.canonicalString());const n=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";(function(o){let l=new qe(tn.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(u=>{u.isInequality()&&(l=l.add(u.field))})}),l})(t).forEach(s=>{e.has(s.canonicalString())||s.isKeyField()||t.Ee.push(new wa(s,n))}),e.has(tn.keyField().canonicalString())||t.Ee.push(new wa(tn.keyField(),n))}return t.Ee}function Kn(i){const t=$t(i);return t.de||(t.de=ny(t,Ws(i))),t.de}function ny(i,t){if(i.limitType==="F")return _d(i.path,i.collectionGroup,t,i.filters,i.limit,i.startAt,i.endAt);{t=t.map(r=>{const s=r.dir==="desc"?"asc":"desc";return new wa(r.field,s)});const e=i.endAt?new Aa(i.endAt.position,i.endAt.inclusive):null,n=i.startAt?new Aa(i.startAt.position,i.startAt.inclusive):null;return _d(i.path,i.collectionGroup,t,i.filters,i.limit,e,n)}}function _c(i,t,e){return new Xa(i.path,i.collectionGroup,i.explicitOrderBy.slice(),i.filters.slice(),t,e,i.startAt,i.endAt)}function ja(i,t){return bu(Kn(i),Kn(t))&&i.limitType===t.limitType}function Dp(i){return`${wu(Kn(i))}|lt:${i.limitType}`}function jr(i){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(r=>Ip(r)).join(", ")}]`),Ga(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(r=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(r)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>as(r)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>as(r)).join(",")),`Target(${n})`}(Kn(i))}; limitType=${i.limitType})`}function $a(i,t){return t.isFoundDocument()&&function(n,r){const s=r.key.path;return n.collectionGroup!==null?r.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(s):Bt.isDocumentKey(n.path)?n.path.isEqual(s):n.path.isImmediateParentOf(s)}(i,t)&&function(n,r){for(const s of Ws(n))if(!s.field.isKeyField()&&r.data.field(s.field)===null)return!1;return!0}(i,t)&&function(n,r){for(const s of n.filters)if(!s.matches(r))return!1;return!0}(i,t)&&function(n,r){return!(n.startAt&&!function(o,l,c){const u=pd(o,l,c);return o.inclusive?u<=0:u<0}(n.startAt,Ws(n),r)||n.endAt&&!function(o,l,c){const u=pd(o,l,c);return o.inclusive?u>=0:u>0}(n.endAt,Ws(n),r))}(i,t)}function iy(i){return i.collectionGroup||(i.path.length%2==1?i.path.lastSegment():i.path.get(i.path.length-2))}function Lp(i){return(t,e)=>{let n=!1;for(const r of Ws(i)){const s=ry(r,t,e);if(s!==0)return s;n=n||r.field.isKeyField()}return 0}}function ry(i,t,e){const n=i.field.isKeyField()?Bt.comparator(t.key,e.key):function(s,o,l){const c=o.data.field(s),u=l.data.field(s);return c!==null&&u!==null?os(c,u):Ht(42886)}(i.field,t,e);switch(i.dir){case"asc":return n;case"desc":return-1*n;default:return Ht(19790,{direction:i.dir})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sy=new Pe(Bt.comparator);function Ei(){return sy}const Np=new Pe(Bt.comparator);function Vs(...i){let t=Np;for(const e of i)t=t.insert(e.key,e);return t}function Up(i){let t=Np;return i.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function pr(){return Xs()}function Op(){return Xs()}function Xs(){return new Sr(i=>i.toString(),(i,t)=>i.isEqual(t))}const oy=new Pe(Bt.comparator),ay=new qe(Bt.comparator);function ie(...i){let t=ay;for(const e of i)t=t.add(e);return t}const ly=new qe(Jt);function cy(){return ly}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xy=new Bi([4294967295,4294967295],0);function xd(i){const t=pp().encode(i),e=new op;return e.update(t),new Uint8Array(e.digest())}function Sd(i){const t=new DataView(i.buffer),e=t.getUint32(0,!0),n=t.getUint32(4,!0),r=t.getUint32(8,!0),s=t.getUint32(12,!0);return[new Bi([e,n],0),new Bi([r,s],0)]}class Pu{constructor(t,e,n){if(this.bitmap=t,this.padding=e,this.hashCount=n,e<0||e>=8)throw new Bs(`Invalid padding: ${e}`);if(n<0)throw new Bs(`Invalid hash count: ${n}`);if(t.length>0&&this.hashCount===0)throw new Bs(`Invalid hash count: ${n}`);if(t.length===0&&e!==0)throw new Bs(`Invalid padding when bitmap length is 0: ${e}`);this.pe=8*t.length-e,this.ye=Bi.fromNumber(this.pe)}we(t,e,n){let r=t.add(e.multiply(Bi.fromNumber(n)));return r.compare(xy)===1&&(r=new Bi([r.getBits(0),r.getBits(1)],0)),r.modulo(this.ye).toNumber()}Se(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.pe===0)return!1;const e=xd(t),[n,r]=Sd(e);for(let s=0;s<this.hashCount;s++){const o=this.we(n,r,s);if(!this.Se(o))return!1}return!0}static create(t,e,n){const r=t%8==0?0:8-t%8,s=new Uint8Array(Math.ceil(t/8)),o=new Pu(s,r,e);return n.forEach(l=>o.insert(l)),o}insert(t){if(this.pe===0)return;const e=xd(t),[n,r]=Sd(e);for(let s=0;s<this.hashCount;s++){const o=this.we(n,r,s);this.be(o)}}be(t){const e=Math.floor(t/8),n=t%8;this.bitmap[e]|=1<<n}}class Bs extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qa{constructor(t,e,n,r,s){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const r=new Map;return r.set(t,uo.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new Qa(qt.min(),r,new Pe(Jt),Ei(),ie())}}class uo{constructor(t,e,n,r,s){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new uo(n,e,ie(),ie(),ie())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ky{constructor(){this.changes=new Sr(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,un.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return n!==void 0?tt.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zy{constructor(t,e,n,r){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=r}getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(r=>(n=r,this.remoteDocumentCache.getEntry(t,e))).next(r=>(n!==null&&qs(n.mutation,r,Dn.empty(),Xe.now()),r))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.getLocalViewOfDocuments(t,n,ie()).next(()=>n))}getLocalViewOfDocuments(t,e,n=ie()){const r=pr();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,n).next(s=>{let o=Vs();return s.forEach((l,c)=>{o=o.insert(l,c.overlayedDocument)}),o}))}getOverlayedDocuments(t,e){const n=pr();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,ie()))}populateOverlays(t,e,n){const r=[];return n.forEach(s=>{e.has(s)||r.push(s)}),this.documentOverlayCache.getOverlays(t,r).next(s=>{s.forEach((o,l)=>{e.set(o,l)})})}computeViews(t,e,n,r){let s=Ei();const o=Xs(),l=function(){return Xs()}();return e.forEach((c,u)=>{const h=n.get(u.key);r.has(u.key)&&(h===void 0||h.mutation instanceof er)?s=s.insert(u.key,u):h!==void 0?(o.set(u.key,h.mutation.getFieldMask()),qs(h.mutation,u,h.mutation.getFieldMask(),Xe.now())):o.set(u.key,Dn.empty())}),this.recalculateAndSaveOverlays(t,s).next(c=>(c.forEach((u,h)=>o.set(u,h)),e.forEach((u,h)=>{var d;return l.set(u,new Qy(h,(d=o.get(u))!==null&&d!==void 0?d:null))}),l))}recalculateAndSaveOverlays(t,e){const n=Xs();let r=new Pe((o,l)=>o-l),s=ie();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(o=>{for(const l of o)l.keys().forEach(c=>{const u=e.get(c);if(u===null)return;let h=n.get(c)||Dn.empty();h=l.applyToLocalView(u,h),n.set(c,h);const d=(r.get(l.batchId)||ie()).add(c);r=r.insert(l.batchId,d)})}).next(()=>{const o=[],l=r.getReverseIterator();for(;l.hasNext();){const c=l.getNext(),u=c.key,h=c.value,d=Op();h.forEach(p=>{if(!s.has(p)){const _=Hp(e.get(p),n.get(p));_!==null&&d.set(p,_),s=s.add(p)}}),o.push(this.documentOverlayCache.saveOverlays(t,u,d))}return tt.waitFor(o)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.recalculateAndSaveOverlays(t,n))}getDocumentsMatchingQuery(t,e,n,r){return function(o){return Bt.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):ey(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,r):this.getDocumentsMatchingCollectionQuery(t,e,n,r)}getNextDocuments(t,e,n,r){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,r).next(s=>{const o=r-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,r-s.size):tt.resolve(pr());let l=Qs,c=s;return o.next(u=>tt.forEach(u,(h,d)=>(l<d.largestBatchId&&(l=d.largestBatchId),s.get(h)?tt.resolve():this.remoteDocumentCache.getEntry(t,h).next(p=>{c=c.insert(h,p)}))).next(()=>this.populateOverlays(t,u,s)).next(()=>this.computeViews(t,c,u,ie())).next(h=>({batchId:l,changes:Up(h)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new Bt(e)).next(n=>{let r=Vs();return n.isFoundDocument()&&(r=r.insert(n.key,n)),r})}getDocumentsMatchingCollectionGroupQuery(t,e,n,r){const s=e.collectionGroup;let o=Vs();return this.indexManager.getCollectionParents(t,s).next(l=>tt.forEach(l,c=>{const u=function(d,p){return new Xa(p,null,d.explicitOrderBy.slice(),d.filters.slice(),d.limit,d.limitType,d.startAt,d.endAt)}(e,c.child(s));return this.getDocumentsMatchingCollectionQuery(t,u,n,r).next(h=>{h.forEach((d,p)=>{o=o.insert(d,p)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(t,e,n,r){let s;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,n.largestBatchId).next(o=>(s=o,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,n,s,r))).next(o=>{s.forEach((c,u)=>{const h=u.getKey();o.get(h)===null&&(o=o.insert(h,un.newInvalidDocument(h)))});let l=Vs();return o.forEach((c,u)=>{const h=s.get(c);h!==void 0&&qs(h.mutation,u,Dn.empty(),Xe.now()),$a(e,u)&&(l=l.insert(c,u))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.oa?(yi(e),this.oa=!1):Tt("OnlineStateTracker",e)}la(){this.sa!==null&&(this.sa.cancel(),this.sa=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yr="RemoteStore";class CE{constructor(t,e,n,r,s){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.ha=[],this.Pa=new Map,this.Ta=new Set,this.Ia=[],this.Ea=s,this.Ea.No(o=>{n.enqueueAndForget(async()=>{Mr(this)&&(Tt(yr,"Restarting streams for network reachability change."),await async function(c){const u=$t(c);u.Ta.add(4),await ho(u),u.da.set("Unknown"),u.Ta.delete(4),await Ja(u)}(this))})}),this.da=new RE(n,r)}}async function Ja(i){if(Mr(i))for(const t of i.Ia)await t(!0)}async function ho(i){for(const t of i.Ia)await t(!1)}function om(i,t){const e=$t(i);e.Pa.has(t.targetId)||(e.Pa.set(t.targetId,t),ku(e)?Bu(e):Es(e).M_()&&Vu(e,t))}function Fu(i,t){const e=$t(i),n=Es(e);e.Pa.delete(t),n.M_()&&am(e,t),e.Pa.size===0&&(n.M_()?n.N_():Mr(e)&&e.da.set("Unknown"))}function Vu(i,t){if(i.Aa.Ke(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(qt.min())>0){const e=i.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}Es(i).H_(t)}function am(i,t){i.Aa.Ke(t),Es(i).J_(t)}function Bu(i){i.Aa=new Sy({getRemoteKeysForTarget:t=>i.remoteSyncer.getRemoteKeysForTarget(t),Rt:t=>i.Pa.get(t)||null,Pt:()=>i.datastore.serializer.databaseId}),Es(i).start(),i.da._a()}function ku(i){return Mr(i)&&!Es(i).F_()&&i.Pa.size>0}function Mr(i){return $t(i).Ta.size===0}function lm(i){i.Aa=void 0}async function IE(i){i.da.set("Online")}async function PE(i){i.Pa.forEach((t,e)=>{Vu(i,t)})}async function DE(i,t){lm(i),ku(i)?(i.da.ca(t),Bu(i)):i.da.set("Unknown")}async function LE(i,t,e){if(i.da.set("Online"),t instanceof qp&&t.state===2&&t.cause)try{await async function(r,s){const o=s.cause;for(const l of s.targetIds)r.Pa.has(l)&&(await r.remoteSyncer.rejectListen(l,o),r.Pa.delete(l),r.Aa.removeTarget(l))}(i,t)}catch(n){Tt(yr,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Pa(i,n)}else if(t instanceof la?i.Aa.Xe(t):t instanceof Xp?i.Aa.ot(t):i.Aa.nt(t),!e.isEqual(qt.min()))try{const n=await im(i.localStore);e.compareTo(n)>=0&&await function(s,o){const l=s.Aa.It(o);return l.targetChanges.forEach((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const h=s.Pa.get(u);h&&s.Pa.set(u,h.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,u)=>{const h=s.Pa.get(c);if(!h)return;s.Pa.set(c,h.withResumeToken(en.EMPTY_BYTE_STRING,h.snapshotVersion)),am(s,c);const d=new Oi(h.target,c,u,h.sequenceNumber);Vu(s,d)}),s.remoteSyncer.applyRemoteEvent(l)}(i,e)}catch(n){Tt(yr,"Failed to raise snapshot:",n),await Pa(i,n)}}async function Pa(i,t,e){if(!ys(t))throw t;i.Ta.add(1),await ho(i),i.da.set("Offline"),e||(e=()=>im(i.localStore)),i.asyncQueue.enqueueRetryable(async()=>{Tt(yr,"Retrying IndexedDB access"),await e(),i.Ta.delete(1),await Ja(i)})}function cm(i,t){return t().catch(e=>Pa(i,e,t))}async function tl(i){const t=$t(i),e=Yi(t);let n=t.ha.length>0?t.ha[t.ha.length-1].batchId:Su;for(;NE(t);)try{const r=await mE(t.localStore,n);if(r===null){t.ha.length===0&&e.N_();break}n=r.batchId,UE(t,r)}catch(r){await Pa(t,r)}um(t)&&hm(t)}function NE(i){return Mr(i)&&i.ha.length<10}function UE(i,t){i.ha.push(t);const e=Yi(i);e.M_()&&e.Y_&&e.Z_(t.mutations)}function um(i){return Mr(i)&&!Yi(i).F_()&&i.ha.length>0}function hm(i){Yi(i).start()}async function OE(i){Yi(i).ta()}async function FE(i){const t=Yi(i);for(const e of i.ha)t.Z_(e.mutations)}async function VE(i,t,e){const n=i.ha.shift(),r=Iu.from(n,t,e);await cm(i,()=>i.remoteSyncer.applySuccessfulWrite(r)),await tl(i)}async function BE(i,t){t&&Yi(i).Y_&&await async function(n,r){if(function(o){return Ty(o)&&o!==ot.ABORTED}(r.code)){const s=n.ha.shift();Yi(n).O_(),await cm(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await tl(n)}}(i,t),um(i)&&hm(i)}async function Ud(i,t){const e=$t(i);e.asyncQueue.verifyOperationInProgress(),Tt(yr,"RemoteStore received new credentials");const n=Mr(e);e.Ta.add(3),await ho(e),n&&e.da.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ta.delete(3),await Ja(e)}async function kE(i,t){const e=$t(i);t?(e.Ta.delete(2),await Ja(e)):t||(e.Ta.add(2),await ho(e),e.da.set("Unknown"))}function Es(i){return i.Ra||(i.Ra=function(e,n,r){const s=$t(e);return s.ra(),new ME(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{e_:IE.bind(null,i),n_:PE.bind(null,i),i_:DE.bind(null,i),j_:LE.bind(null,i)}),i.Ia.push(async t=>{t?(i.Ra.O_(),ku(i)?Bu(i):i.da.set("Unknown")):(await i.Ra.stop(),lm(i))})),i.Ra}function Yi(i){return i.Va||(i.Va=function(e,n,r){const s=$t(e);return s.ra(),new AE(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{e_:()=>Promise.resolve(),n_:OE.bind(null,i),i_:BE.bind(null,i),X_:FE.bind(null,i),ea:VE.bind(null,i)}),i.Ia.push(async t=>{t?(i.Va.O_(),await tl(i)):(await i.Va.stop(),i.ha.length>0&&(Tt(yr,`Stopping write stream with ${i.ha.length} pending writes`),i.ha=[]))})),i.Va}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zu{constructor(t,e,n,r,s){this.asyncQueue=t,this.timerId=e,this.targetTimeMs=n,this.op=r,this.removalCallback=s,this.deferred=new ki,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(o=>{})}get promise(){return this.deferred.promise}static createAndSchedule(t,e,n,r,s){const o=Date.now()+n,l=new zu(t,e,o,r,s);return l.start(n),l}start(t){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),t)}skipDelay(){return this.handleDelayElapsed()}cancel(t){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new Dt(ot.CANCELLED,"Operation cancelled"+(t?": "+t:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(t=>this.deferred.resolve(t))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Hu(i,t){if(yi("AsyncQueue",`${t}: ${i}`),ys(i))return new Dt(ot.UNAVAILABLE,`${t}: ${i}`);throw i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sm{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.vu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.vu(this.observer.error,t):yi("Uncaught Error in snapshot listener:",t.toString()))}Cu(){this.muted=!0}vu(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nl{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new nl(this.firestore,t,this._query)}}class mn{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new zi(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new mn(this.firestore,t,this._key)}}class zi extends nl{constructor(t,e,n){super(t,e,qa(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new mn(this.firestore,null,new Bt(t))}withConverter(t){return new zi(this.firestore,t,this._path)}}function js(i,t,...e){if(i=gi(i),wm("collection","path",t),i instanceof el){const n=Ce.fromString(t,...e);return Wd(n),new zi(i,null,n)}{if(!(i instanceof mn||i instanceof zi))throw new Dt(ot.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=i._path.child(Ce.fromString(t,...e));return Wd(n),new zi(i.firestore,null,n)}}function ju(i,t,...e){if(i=gi(i),arguments.length===1&&(t=mp.newId()),wm("doc","path",t),i instanceof el){const n=Ce.fromString(t,...e);return Gd(n),new mn(i,null,new Bt(n))}{if(!(i instanceof mn||i instanceof zi))throw new Dt(ot.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=i._path.child(Ce.fromString(t,...e));return Gd(n),new mn(i.firestore,i instanceof zi?i.converter:null,new Bt(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M0(i){if(i.limitType==="L"&&i.explicitOrderBy.length===0)throw new Dt(ot.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class A0{convertValue(t,e="none"){switch($i(t)){case 0:return null;case 1:return t.booleanValue;case 2:return Ue(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(ji(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw Ht(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const n={};return tr(t,(r,s)=>{n[r]=this.convertValue(s,e)}),n}convertVectorValue(t){var e,n,r;const s=(r=(n=(e=t.fields)===null||e===void 0?void 0:e[Ma].arrayValue)===null||n===void 0?void 0:n.values)===null||r===void 0?void 0:r.map(o=>Ue(o.doubleValue));return new Qu(s)}convertGeoPoint(t){return new Ku(Ue(t.latitude),Ue(t.longitude))}convertArray(t,e){return(t.values||[]).map(n=>this.convertValue(n,e))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Wa(t);return n==null?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(Zs(t));default:return null}}convertTimestamp(t){const e=qi(t);return new Xe(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=Ce.fromString(t);_e(Jp(n),9688,{name:t});const r=new Js(n.get(1),n.get(3)),s=new Bt(n.popFirst(5));return r.isEqual(e)||yi(`Document ${s} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Fm extends Nm{constructor(t,e,n,r,s,o){super(t,e,n,r,o),this._firestore=t,this._firestoreImpl=t,this.metadata=s}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new ca(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Um("DocumentSnapshot.get",t));if(n!==null)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class ca extends Fm{data(t={}){return super.data(t)}}class w0{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new ks(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new ca(this._firestore,this._userDataWriter,n.key,n,new ks(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new Dt(ot.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(r,s){if(r._snapshot.oldDocs.isEmpty()){let o=0;return r._snapshot.docChanges.map(l=>{const c=new ca(r._firestore,r._userDataWriter,l.doc.key,l.doc,new ks(r._snapshot.mutatedKeys.has(l.doc.key),r._snapshot.fromCache),r.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=r._snapshot.oldDocs;return r._snapshot.docChanges.filter(l=>s||l.type!==3).map(l=>{const c=new ca(r._firestore,r._userDataWriter,l.doc.key,l.doc,new ks(r._snapshot.mutatedKeys.has(l.doc.key),r._snapshot.fromCache),r.query.converter);let u=-1,h=-1;return l.type!==0&&(u=o.indexOf(l.doc.key),o=o.delete(l.doc.key)),l.type!==1&&(o=o.add(l.doc),h=o.indexOf(l.doc.key)),{type:b0(l.type),doc:c,oldIndex:u,newIndex:h}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function b0(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Ht(61501,{type:i})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function Cf(){return new Ji({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fh(),fragmentShader:`
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function If(){return new Ji({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fh(),fragmentShader:`
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function fh(){return`
...
`)}function nw(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zs).join(`
...
#define LOW_PRECISION`),t}function uw(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Hm?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===O0?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===hi&&(t="SHADOWMAP_TYPE_VSM"),t}function hw(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ds:case fs:t="ENVMAP_TYPE_CUBE";break;case al:t="ENVMAP_TYPE_CUBE_UV";break}return t}function dw(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fs:t="ENVMAP_MODE_REFRACTION";break}return t}function fw(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Gm:t="ENVMAP_BLENDING_MULTIPLY";break;case eT:t="ENVMAP_BLENDING_MIX";break;case nT:t="ENVMAP_BLENDING_ADD";break}return t}function pw(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function mw(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,l=e.fragmentShader;const c=uw(e),u=hw(e),h=dw(e),d=fw(e),p=pw(e),_=nw(e),x=iw(s),b=r.createProgram();let g,m,N=e.glslVersion?"#version "+e.glslVersion+`
...
`)}async function db(){_h(),Ie&&(Ie.close(),Ie=null),gr&&(gr.getTracks().forEach(i=>i.stop()),gr=null),pn&&(await P0(pn).catch(i=>console.error("ドキュメント削除エラー: ",i)),pn=null),lo()}function lo(){Fa.srcObject=null,Tn.srcObject=null,Fa.style.display="none",Tn.style.display="none",mh.style.display="none",_u.style.display="none",hl.textContent="",v_.value="",ga.textContent="コピー",gu.disabled=!1,vu.disabled=!1,cn&&(cn.dispose(),cn.domElement.parentNode&&document.body.removeChild(cn.domElement),cn=null,Wi=null,za=null,Ni=null),Va.textContent="",_i=[],ao=!1,qn=null,dl.disabled=!1,fl.disabled=!0,pl.disabled=!0}function fb(){!Ie||ao||(ao=!0,_i=[],qn=null,dl.disabled=!0,fl.disabled=!1,pl.disabled=!0,Va.textContent="記録中...",y_=setInterval(async()=>{if(!Ie)return;const i=await Ie.getStats(),t={timestamp:new Date().toISOString()};$s==="sender"?i.forEach(e=>{if(e.type==="outbound-rtp"&&e.mediaType==="video"){const n=qn==null?void 0:qn.get(e.id),r=e.bytesSent-((n==null?void 0:n.bytesSent)??0),s=e.packetsSent-((n==null?void 0:n.packetsSent)??0);t.sent_resolution=`${e.frameWidth}x${e.frameHeight}`,t.sent_fps=e.framesPerSecond,t.sent_bitrate_kbps=Math.round(Math.max(0,r)*8/1e3),t.packets_sent_per_second=Math.max(0,s),t.total_encode_time_s=e.totalEncodeTime,t.keyframes_encoded=e.keyFramesEncoded,t.quality_limitation_reason=e.qualityLimitationReason,t.quality_limitation_resolution_changes=e.qualityLimitationResolutionChanges,t.retransmitted_packets_sent=e.retransmittedPacketsSent,t.nack_count=e.nackCount}e.type==="remote-inbound-rtp"&&e.mediaType==="video"&&(t.receiver_jitter_ms=(e.jitter*1e3).toFixed(3)??"N/A",t.receiver_packets_lost=e.packetsLost,t.receiver_fraction_lost=e.fractionLost,t.rtt_rtcp_ms=(e.roundTripTime*1e3).toFixed(3)??"N/A"),e.type==="candidate-pair"&&e.nominated&&e.state==="succeeded"&&(t.available_outgoing_bitrate_kbps=e.availableOutgoingBitrate?Math.round(e.availableOutgoingBitrate/1e3):"N/A",t.rtt_ice_ms=(e.currentRoundTripTime*1e3).toFixed(3)??"N/A")}):i.forEach(e=>{if(e.type==="inbound-rtp"&&e.mediaType==="video"){const n=qn==null?void 0:qn.get(e.id),r=e.bytesReceived-((n==null?void 0:n.bytesReceived)??0),s=e.packetsReceived-((n==null?void 0:n.packetsReceived)??0);t.received_resolution=`${e.frameWidth}x${e.frameHeight}`,t.received_fps=e.framesPerSecond,t.received_bitrate_kbps=Math.round(Math.max(0,r)*8/1e3),t.packets_received_per_second=Math.max(0,s),t.jitter_ms=(e.jitter*1e3).toFixed(3)??"N/A",t.packets_lost=e.packetsLost,t.frames_dropped=e.framesDropped,t.total_decode_time_s=e.totalDecodeTime,t.keyframes_decoded=e.keyFramesDecoded,t.jitter_buffer_delay_s=e.jitterBufferDelay,t.fir_count=e.firCount,t.pli_count=e.pliCount,t.jitter_buffer_emitted_count=e.jitterBufferEmittedCount}}),Object.keys(t).length>1&&(_i.push(t),Va.textContent=`記録中... ${_i.length} 個`),qn=i},1e3))}function _h(){ao&&(clearInterval(y_),ao=!1,qn=null,dl.disabled=!1,fl.disabled=!0,pl.disabled=_i.length===0,Va.textContent=`記録停止。合計 ${_i.length} 件。`)}function pb(){if(_i.length===0)return alert("ダウンロードするデータがありません。");const i=new Set;_i.forEach(o=>{Object.keys(o).forEach(l=>i.add(l))});const t=Array.from(i),e=[t.join(",")];_i.forEach(o=>{const l=t.map(c=>{const u=o[c]!==void 0?o[c]:"",h=String(u);return h.includes(",")?`"${h.replace(/"/g,'""')}"`:h});e.push(l.join(","))});const n=new Blob([e.join(`
`)],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(n),s=document.createElement("a");s.href=r,s.download=`webrtc_stats_${$s}_${new Date().toISOString().replace(/[:.]/g,"-")}.csv`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(r)}rb.forEach(i=>{i.addEventListener("change",()=>{$s=document.querySelector('input[name="role"]:checked').value,sb.style.display=$s==="sender"?"block":"none",ob.style.display=$s==="receiver"?"block":"none",lo()})});ga.onclick=()=>{navigator.clipboard.writeText(hl.textContent.trim()).then(()=>{ga.textContent="コピー済み",setTimeout(()=>{ga.textContent="コピー"},1500)})};gu.onclick=async()=>{gu.disabled=!0;const i={video:ub[ab.value],audio:!0};try{gr=await navigator.mediaDevices.getUserMedia(i),Fa.srcObject=gr,Fa.style.display="block",E_(),pn=ju(js(zm,"calls")),Ba=js(pn,"offerCandidates"),ka=js(pn,"answerCandidates"),gr.getTracks().forEach(n=>Ie.addTrack(n,gr)),Ie.onicecandidate=n=>{n.candidate&&Bm(Ba,n.candidate.toJSON())};const t=await Ie.createOffer(),e=hb(t.sdp,lb.value);await Ie.setLocalDescription({type:t.type,sdp:e}),await C0(pn,{offer:{type:t.type,sdp:e}}),hl.textContent=pn.id,mh.style.display="block",Rc(pn,n=>{const r=n.data();r!=null&&r.answer&&!Ie.currentRemoteDescription&&Ie.setRemoteDescription(new RTCSessionDescription(r.answer))}),Rc(ka,n=>{n.docChanges().forEach(r=>{r.type==="added"&&Ie.addIceCandidate(new RTCIceCandidate(r.doc.data()))})})}catch(t){console.error("カメラの開始エラー:",t),alert("カメラのアクセスに失敗しました。"),lo()}};vu.onclick=async()=>{const i=v_.value.trim();if(!i)return alert("Call ID を入力してください");vu.disabled=!0;try{pn=ju(zm,"calls",i);const t=(await R0(pn)).data();if(t!=null&&t.offer){Ba=js(pn,"offerCandidates"),ka=js(pn,"answerCandidates"),E_(),Ie.ontrack=n=>{const r=n.streams[0];Tn.srcObject=r,Tn.style.display="block",Tn.style.position="fixed",Tn.style.bottom="20px",Tn.style.left="20px",Tn.style.width="240px",Tn.style.height="auto",Tn.style.border="2px solid white",Tn.style.zIndex="1001",Tn.onloadedmetadata=()=>{Tn.play().then(()=>{mb(),T_()})}},Ie.onicecandidate=n=>{n.candidate&&Bm(ka,n.candidate.toJSON())},await Ie.setRemoteDescription(new RTCSessionDescription(t.offer));const e=await Ie.createAnswer();await Ie.setLocalDescription(e),await I0(pn,{answer:e}),hl.textContent=pn.id,mh.style.display="block",Rc(Ba,n=>{n.docChanges().forEach(r=>{r.type==="added"&&Ie.addIceCandidate(new RTCIceCandidate(r.doc.data()))})})}else alert("指定されたCall IDが見つかりません。"),lo()}catch(t){console.error("通話への参加エラー:",t),alert("通話への参加に失敗しました。"),lo()}};cb.onclick=db;dl.onclick=fb;fl.onclick=_h;pl.onclick=pb;function mb(){Wi=new Un(75,window.innerWidth/window.innerHeight,1,1e3),Wi.position.set(0,0,.1),za=new ZT;const i=new ex(Tn);i.colorSpace=Pn,i.minFilter=Mn,i.magFilter=Mn,cn=new Gw;const t=cn.capabilities.getMaxAnisotropy();i.anisotropy=t;const e=new dh(100,64,64);e.scale(-1,1,1);const n=new hh({map:i});za.add(new Yn(e,n)),cn.setPixelRatio(window.devicePixelRatio),cn.setSize(window.innerWidth,window.innerHeight),cn.domElement.style.zIndex="1000",document.body.appendChild(cn.domElement),Ni=new Xw(Wi,cn.domElement),Ni.enableZoom=!0,Ni.zoomSpeed=5,Ni.minDistance=1,Ni.maxDistance=100,Ni.enablePan=!1,window.addEventListener("resize",_b,!1)}function _b(){Wi&&cn&&(Wi.aspect=window.innerWidth/window.innerHeight,Wi.updateProjectionMatrix(),cn.setSize(window.innerWidth,window.innerHeight))}function T_(){cn&&(requestAnimationFrame(T_),Ni.update(),cn.render(za,Wi))}
