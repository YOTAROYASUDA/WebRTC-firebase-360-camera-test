 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hr=new kf("@firebase/firestore");function kr(){return hr.logLevel}function Tt(i,...t){if(hr.logLevel<=ue.DEBUG){const e=t.map(cu);hr.debug(`Firestore (${hs}): ${i}`,...e)}}function mi(i,...t){if(hr.logLevel<=ue.ERROR){const e=t.map(cu);hr.error(`Firestore (${hs}): ${i}`,...e)}}function Qr(i,...t){if(hr.logLevel<=ue.WARN){const e=t.map(cu);hr.warn(`Firestore (${hs}): ${i}`,...e)}}function cu(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(i,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,Qf(i,n,e)}function Qf(i,t,e){let n=`FIRESTORE (${hs}) INTERNAL ASSERTION FAILED: ${t} (ID: ${i.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw mi(n),new Error(n)}function _e(i,t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,i||Qf(t,r,n)}function $t(i,t){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mu(i,t){if(i.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ma(t)?"-0":t}}function Sp(i){return{integerValue:""+i}}function Zv(i,t){return Sv(t)?Sp(t):mu(i,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
#define LOW_PRECISION`),t}function $A(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Rm?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===E0?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ai&&(t="SHADOWMAP_TYPE_VSM"),t}function YA(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case os:case as:t="ENVMAP_TYPE_CUBE";break;case $a:t="ENVMAP_TYPE_CUBE_UV";break}return t}function KA(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case as:t="ENVMAP_MODE_REFRACTION";break}return t}function ZA(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Cm:t="ENVMAP_BLENDING_MULTIPLY";break;case B0:t="ENVMAP_BLENDING_MIX";break;case k0:t="ENVMAP_BLENDING_ADD";break}return t}function QA(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function JA(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,l=e.fragmentShader;const c=$A(e),u=YA(e),h=KA(e),d=ZA(e),p=QA(e),_=kA(e),x=zA(s),b=r.createProgram();let g,m,N=e.glslVersion?"#version "+e.glslVersion+`
